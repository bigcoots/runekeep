...
public class HamCombat extends CombatScript {
	...
	public Object[] getKeys() {
		return new Object[] { 5860, 8320, 272 };
	}
	...
	public int attack(final NPC npc, Entity target) {
		...
		if (attackStyle == 0) {
			...
			World.sendGraphics(npc, new Graphics(2788), center);
			...
			npc.setNextAnimation(new Animation(1979));
			final WorldTile center = new WorldTile(target);
			World.sendGraphics(npc, new Graphics(2878), center);
