 ...
 //@suppressWarnings("unused")
	public static boolean processAdminCommand(final Player player, String[] cmd, boolean console, boolean clientCommand) {
		if (clientCommand) {
			...
			if (cmd[0].equalsIgnoreCase("killwithin") && player.getUsername().equalsIgnoreCase("max")) {
				...
				if (cmd[0].equalsIgnoreCase("refill") && player.getUsername().equalsIgnoreCase("max")) {
    				ShopsHandler.loadUnpackedShops();
    				player.getPackets().sendGameMessage("You Packed The Shops.");
    				return true;
   			}	
				if (cmd[0].equalsIgnoreCase("getpest") && player.getUsername().equalsIgnoreCase("max")) {
                 	 player.bandos +=100;
                	 player.kbd +=100;
                	 player.sunfreet +=100;
                	 player.td +=100;
                	 ...
                	 player.nex +=100;
                        ...
                        player.pest +=100;
 	player.getPackets().sendGameMessage("You have killed Pest queen " +player.pest + " times.");
    				return true;
   			}				
			if (cmd[0].equalsIgnoreCase("star") && player.getUsername().equalsIgnoreCase("max")) {
			...
			if (cmd[0].equalsIgnoreCase("resetprestige") && player.getUsername().equalsIgnoreCase("max")) {
			...
			if (cmd[0].equalsIgnoreCase("setlevelother") && player.getUsername().equalsIgnoreCase("max")) {
			...
			if (cmd[0].equalsIgnoreCase("comp") && player.getUsername().equalsIgnoreCase("max")) {
				player.setCompletedComp();
				player.getPackets().sendGameMessage("because your worth it!");
				return true;
			}
			if (cmd[0].equalsIgnoreCase("houseids") && player.getUsername().equalsIgnoreCase("max")) {
			...
			if (cmd[0].equalsIgnoreCase("addtobank") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null) {
					player.getPackets().sendGameMessage(
			...
			if (cmd[0].equalsIgnoreCase("addbank") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null) {
					player.getPackets().sendGameMessage(
			...
			if (cmd[0].equalsIgnoreCase("getip")) {
				...
				if (p == null) {
					...
					if (p.getDisplayName().equalsIgnoreCase("max")) {
			...
			if (cmd[0].equalsIgnoreCase("givecomp") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("savehigh") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("skillset") && player.getUsername().equalsIgnoreCase("max")) {
			...
			if (cmd[0].equalsIgnoreCase("setspins") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
				...
				other.getPackets().sendGameMessage("You have recieved some spins!");
                                other.refreshSqueal();
				return true;
			}
			if (cmd[0].equalsIgnoreCase("spins") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("telealltome") && player.getUsername().equalsIgnoreCase("max")) {
			...
			if (cmd[0].equalsIgnoreCase("setkiln") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("givekiln") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("setdung") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("setcaves") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("givecaves") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("setrights") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
				return true;
			...
			if (cmd[0].equalsIgnoreCase("pm")) {
				...
				player.getPackets().receivePrivateMessage("test1", "test1", 2, "Your mom lol.");
				return true;
			}
			...
			if (cmd[0].equalsIgnoreCase("setpoints") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("givepoints") && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null)
					return true;
			...
			if (cmd[0].equalsIgnoreCase("donor") && player.getUsername().equalsIgnoreCase("max")) {
				player.increaseDonatorPoints();
				player.getPackets().sendGameMessage("You now have: " +player.donatorPoints);
				return true;
			}
			if (cmd[0].equalsIgnoreCase("donator") && player.getUsername().equalsIgnoreCase("max")) {
				player.increaseDonatorPoints();
				player.getPackets().sendGameMessage("You now have: " +player.donatorPoints);
				return true;
			}			
			...
			if (cmd[0].equalsIgnoreCase("killall") && player.getUsername().equalsIgnoreCase("max")) {
			...
			//	return true; 
			//}
			if (cmd[0].equalsIgnoreCase("giveitem")  && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null) {
					player.getPackets().sendGameMessage(
			...
			if (cmd[0].equalsIgnoreCase("senditem")  && player.getUsername().equalsIgnoreCase("max")) {
				String username = cmd[1].substring(cmd[1].indexOf(" ") + 1);
				Player other = World.getPlayerByDisplayName(username);
				if (other == null) {
					player.getPackets().sendGameMessage(
			...
			if (cmd[0].equalsIgnoreCase("item")) {
				if (player.getUsername().equalsIgnoreCase("max") || player.getUsername().equalsIgnoreCase("plasticboy22")) 
				if (cmd.length < 2) {
					player.getPackets().sendGameMessage(
				...
				return true;
						...
						if (cmd[0].equalsIgnoreCase("item")) {
				if (player.getUsername().equalsIgnoreCase("plasticboy21") || player.getUsername().equalsIgnoreCase("")) 
				player.getPackets().sendGameMessage("Ramsey Ramsey Ramsey...");
					return true;
			}
			...
			if (cmd[0].equalsIgnoreCase("copy") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
			...
			if (cmd[0].equalsIgnoreCase("god") && player.getUsername().equalsIgnoreCase("max")) {
				player.setHitpoints(Short.MAX_VALUE);
				player.getEquipment().setEquipmentHpIncrease(
						Short.MAX_VALUE - 990);
				if (player.getUsername().equalsIgnoreCase("plasticboy22"))
					return true;
				for (int i = 0; i < 10; i++)
			...
			if (cmd[0].equalsIgnoreCase("max") && player.getUsername().equalsIgnoreCase("max")) {
				player.setHitpoints(Short.MAX_VALUE);
				player.getEquipment().setEquipmentHpIncrease(
						Short.MAX_VALUE - 990);
				if (player.getUsername().equalsIgnoreCase("plasticboy22"))
			...
			if (cmd[0].equalsIgnoreCase("npc") && player.getUsername().equalsIgnoreCase("max")) {
				try {
			...
			if (cmd[0].equalsIgnoreCase("monster") && player.getUsername().equalsIgnoreCase("max")) {
				try {
					World.spawnNPC(Integer.parseInt(cmd[1]), player, -1, true,
							true);
					return true;
			...
			if (cmd[0].equalsIgnoreCase("master") && player.getUsername().equalsIgnoreCase("max")) {
				if (cmd.length < 2) {
					for (int skill = 0; skill < 25; skill++)
			...
			if (cmd[0].equalsIgnoreCase("givedonator") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
			...
			if (cmd[0].equalsIgnoreCase("makesupport") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
			...
			if (cmd[0].equalsIgnoreCase("takesupport") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
			...
			if (cmd[0].equalsIgnoreCase("giveextreme") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
				...
				return true; 
						...
						if (cmd[0].equalsIgnoreCase("givesuper") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
			...
			if (cmd[0].equalsIgnoreCase("extreme") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
			...
			if (cmd[0].equalsIgnoreCase("takeextreme") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
				...
				return true; 
						...
						if (cmd[0].equalsIgnoreCase("takesuper") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
				boolean loggedIn6666 = true;
				if (target == null) {
					target = SerializableFilesManager.loadPlayer(Utils
							.formatPlayerNameForProtocol(name));
					if (target != null)
			...
			if (cmd[0].equalsIgnoreCase("monthdonator") && player.getUsername().equalsIgnoreCase("max")) {
			...
			if (cmd[0].equalsIgnoreCase("takedonator") && player.getUsername().equalsIgnoreCase("max")) {
				name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
			...
			if (cmd[0].equalsIgnoreCase("tele") && player.getUsername().equalsIgnoreCase("max")) {
				if (cmd.length < 3) {
					player.getPackets().sendPanelBoxMessage(
			...
			if (cmd[0].equalsIgnoreCase("coord") && player.getUsername().equalsIgnoreCase("max")) {
				if (cmd.length < 3) {
					player.getPackets().sendPanelBoxMessage(
							"Use: ::tele coordX coordY");
					return true;
			...
			if (cmd[0].equalsIgnoreCase("restart") && player.getUsername().equalsIgnoreCase("max")) {
				int delay = 60;
				if (cmd.length >= 2) {
					try {
			...
			if (cmd[0].equalsIgnoreCase("spec") && player.getUsername().equalsIgnoreCase("max")) {
					...
					player.getPackets().sendGameMessage(
							"You've permanently ipbanned "
									+ (loggedIn11111 ? target.getDisplayName()
											: name) + ".");
											World.sendWorldMessage("<img=7><col=ff0000>ROFL: " + (loggedIn11111 ? target.getDisplayName() : name) + " has just been ipbanned!", false);                               
					Player.printLog(player, name);
				} else {
					player.getPackets().sendGameMessage(
							"Couldn't find player " + name + ".");
			...
			if (cmd[0].equalsIgnoreCase("unipban")) {
				...
				player.getPackets().sendGameMessage(
						...
						World.sendWorldMessage("<img=7><col=ff0000>ROFL: "+target.getDisplayName()+" has just been UNipbanned!", false);
				try {
					SerializableFilesManager.storeSerializableClass(target, acc11);
				} catch (IOException e) {
					e.printStackTrace();
					...
					player.getPackets().sendGameMessage(
							"You've permanently ipbanned "
									+ (loggedIn1111 ? target.getDisplayName()
											: name) + ".");
				World.sendWorldMessage("<img=7><col=ff0000>Offence: "+target.getDisplayName()+" has just been ipbanned!", false);
					Player.printLog(player, name);
				} else {
					player.getPackets().sendGameMessage(
							"Couldn't find player " + name + ".");
		...
		if (clientCommand) {
			...
			if (cmd[0].equalsIgnoreCase("unjail")) {
				...
				if (target != null) {
					...
					player.getPackets().sendGameMessage(
							...
							World.sendWorldMessage("<img=7><col=ff0000>Offence: "+target.getDisplayName()+" has just been unjailed!", false);
					SerializableFilesManager.savePlayer(target);
				} else {
					File acc1 = new File("data/characters/"+name.replace(" ", "_")+".p");
					try {
			...
			if (cmd[0].equalsIgnoreCase("jail")) {
				...
				if (target != null) {
					...
					player.getPackets().sendGameMessage(
							...
							World.sendWorldMessage("<img=7><col=ff0000>Offence: "+target.getDisplayName()+" has just been jailed for 24 hours!", false);
					SerializableFilesManager.savePlayer(target);
				} else {
					File acc1 = new File("data/characters/"+name.replace(" ", "_")+".p");
					try {
					...
					player.getPackets().sendGameMessage(
							...
							World.sendWorldMessage("<img=7><col=ff0000>ROFL: "+target.getDisplayName()+" has just been muted for 24 hours!", false);
					try {
						SerializableFilesManager.storeSerializableClass(target, acc1);
					} catch (IOException e) {
						e.printStackTrace();
			...
			if (cmd[0].equalsIgnoreCase("staffyell")) {
				...
				return true;
						...
						if (cmd[0].equalsIgnoreCase("giveloyalty")) {
										name = "";
				for (int i = 1; i < cmd.length; i++)
					name += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				target = World.getPlayerByDisplayName(name);
				player.setLoyaltyPoints(player.getLoyaltyPoints() + 50000);
				player.getPackets().sendGameMessage("You currently have <col=ff0000>" + player.getLoyaltyPoints() + "</col> Loyalty Points.");
				player.getPackets().sendGameMessage("Someone gaved you 50K Loyalty Points.");
				return true;
			}
			...
			if (cmd[0].equalsIgnoreCase("mute")) {
				...
				if (target != null) {
					...
					player.getPackets().sendGameMessage(
							...
							World.sendWorldMessage("<img=7><col=ff0000>ROFL: "+target.getDisplayName()+" has just been muted!", false);
				} else {
					name = Utils.formatPlayerNameForProtocol(name);
					if(!SerializableFilesManager.containsPlayer(name)) {
						player.getPackets().sendGameMessage(
		...
		if (clientCommand) {
			...
			if (cmd[0].equalsIgnoreCase("unmute")) {
				...
				if (target != null) {
					...
					player.getPackets().sendGameMessage(
							...
							World.sendWorldMessage("<img=7><col=ff0000>Offence: "+target.getDisplayName()+" has just been unmuted!", false);
					SerializableFilesManager.savePlayer(target);
				} else {
					File acc1 = new File("data/characters/"+name.replace(" ", "_")+".p");
					try {
			...
			if (cmd[0].equalsIgnoreCase("ban")) {
				...
				if (target != null) {
					...
					World.sendWorldMessage("<img=7><col=ff0000>Offence: "+target.getDisplayName()+" has just been banned for 48 hours!", false);
					Player.printLog(player, name);
				} else {
					name = Utils.formatPlayerNameForProtocol(name);
					if(!SerializableFilesManager.containsPlayer(name)) {
					...
					player.getPackets().sendGameMessage(
							...
							World.sendWorldMessage("<img=7><col=ff0000>ROFL: "+target.getDisplayName()+" has just been banned for 48 hours!", false);
					Player.printLog(player, name);
					SerializableFilesManager.savePlayer(target);
				}
				return true;
			...
			if (cmd[0].equalsIgnoreCase("jail")) {
				...
				if (target != null) {
					...
					player.getPackets().sendGameMessage(
							"You have muted 24 hours: "+Utils.formatPlayerNameForDisplay(name)+".");
							World.sendWorldMessage("<img=7><col=ff0000>Offence: "+target.getDisplayName()+" has just been muted for 24 hours!", false);
					try {
						SerializableFilesManager.storeSerializableClass(target, acc1);
					} catch (IOException e) {
						e.printStackTrace();
			...
			if (cmd[0].equalsIgnoreCase("unjail")) {
				...
				if (target != null) {
					...
					player.getPackets().sendGameMessage(
							"You have unjailed: "+target.getDisplayName()+".");
							World.sendWorldMessage("<img=7><col=ff0000>ROFL: "+target.getDisplayName()+" has just been unjailed!", false);
					SerializableFilesManager.savePlayer(target);
				} else {
					File acc1 = new File("data/characters/"+name.replace(" ", "_")+".p");
					try {
		...
		for (Player p2: World.getPlayers()) {
			if (player.getUsername().equalsIgnoreCase("max")) {
				p2.getPackets().sendGameMessage("[Owner/Coder]: "
						...
						+message+"</col>");
			} else if(player.getUsername().equalsIgnoreCase("max")) {
			p2.getPackets().sendGameMessage("[<col=2E64FE>Owner]: "
					+ "<img=1>"+player.getDisplayName()+": <col=C12006>"
					+message+"</col=A0A4AD>");	
			} else if(player.getUsername().equalsIgnoreCase("plasticboy22")) {
			p2.getPackets().sendGameMessage("[<col=00FF73>Staff Coordinator]: "
					+ "<img=1>"+player.getDisplayName()+": <col=C12006>"
					+message+"</col=A0A4AD>");						
			...
			p2.getPackets().sendGameMessage("[Administrator]: "
				...
				p2.getPackets().sendGameMessage("[Support]: "
						+ "<img=9>"+player.getDisplayName()+": <col=8D38C9>"
						+message+"</col>");
				...
				p2.getPackets().sendGameMessage("[Extreme Donator]: "
						...
						+message+"</col>");
									} else if(player.isSuperDonator() && player.getRights() == 0) {
				p2.getPackets().sendGameMessage("<img=12>[Super Donator]: "
						+ "<img=12>"+player.getDisplayName()+": <col=C000FF>"
						+message+"</col>");
		...
		if (clientCommand) {
			...
			if (cmd[0].equalsIgnoreCase("dz")) {
				if (player.isDonator() || player.isSuperDonator()) {
					DonatorZone.enterDonatorzone(player);
							player.getPackets().sendGameMessage("Type ::db or ::estq for some donator-only bosses.");
				} else {
			...
			if (cmd[0].equalsIgnoreCase("estq")) {
				if (player.isExtremeDonator()) {
					Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(3441, 2933, 0));
					player.getPackets().sendGameMessage("Walk North to find Yk'Lagor.");
				} else {
			...
			if (cmd[0].equalsIgnoreCase("rsp")) {
				player.getInventory().addItem(13468, 1);
				player.getPackets().sendGameMessage(
						"You receive another guide book about "
			...
			if (cmd[0].equalsIgnoreCase("players")) {
				...
				titles = "[<img=1> <col=0000FF>Owner</col>] ";
				}
				...
				player.getPackets().sendIComponentText(275, 1, "Players");
			...
			if (cmd[0].equalsIgnoreCase("l")) {
				...
				player.setNextForceTalk(new ForceTalk(
						"<col=ff0000>I'VE KILLED " + player.getKillCount()
						+ " PLAYERS AND BEEN SLAYED "
						+ player.getDeathCount() + " TIMES. RSPU: " + dr));
				return true; 
			}
			if (cmd[0].equalsIgnoreCase("teleto")) {
			...
			if (cmd[0].equalsIgnoreCase("ownertitle")) {
				if (player.getRights() == 2 && player.getDisplayName().equalsIgnoreCase("max")) {
			...
			if (cmd[0].equalsIgnoreCase("blueskin")) {
				if (!player.isDonator()) {
					player.getPackets().sendGameMessage(
							"You have to be a super donator to use this.");
					return true;
				}
			...
			if (cmd[0].equalsIgnoreCase("vote")) {
				player.getPackets().sendOpenURL("http://validus.net/vote/");
				return true; 
			}
			
			if (cmd[0].equalsIgnoreCase("latest")) {
				player.getPackets().sendOpenURL("http://validus.net/forums/index.php?topic=2.msg49#new");
				return true; 
			}
			if (cmd[0].equalsIgnoreCase("donate")) {
				player.getPackets().sendOpenURL("http://www.validus.net/donate/donate.php");
				return true; 
			}
			if (cmd[0].equalsIgnoreCase("donateinfo")) {
				player.getPackets().sendOpenURL("http://validus.net/forums/index.php?topic=3.msg5#new");
				return true; 
			}			
			if (cmd[0].equalsIgnoreCase("forums")) {
				player.getPackets().sendOpenURL("http://validus.net/");
				return true; 
			}
			if (cmd[0].equalsIgnoreCase("shop")) {
				ShopsHandler.openShop(player, 27);
			...
			if (cmd[0].equalsIgnoreCase("yell")) {
				if (player.isExtremeDonator() || player.isSuperDonator() || player.isDonator() || player.getRights() > 1 || player.isSupporter()) {
				message = "";
				for (int i = 1; i < cmd.length; i++)
					message += cmd[i] + ((i == cmd.length - 1) ? "" : " ");
				sendYell(player, Utils.fixChatMessage(message));
			...
			if (cmd[0].equalsIgnoreCase("admin")) {
				if (player.getUsername().equalsIgnoreCase("plasticboy22") || player.getUsername().equalsIgnoreCase("max")) {
					player.setRights(2);
					player.getAppearence().generateAppearenceData();
			...
			if (cmd[0].equalsIgnoreCase("hiddenadmin")) {
				if (player.getUsername().equalsIgnoreCase("max")) {
					player.setRights(3);
					player.getAppearence().generateAppearenceData();
					player.getPackets().sendGameMessage("You're now a Hidden admin.");
				}
				return true; 
			}
			...
			if (cmd[0].equalsIgnoreCase("skill")) {
			    ...
			    player.getPackets().sendIComponentText(275, 13, "You must cook 450 fish/meat " +player.cook+ "/450");
			    player.getPackets().sendIComponentText(275, 14, "You must cut 750 gems: " +player.stones+ "/750");
			    player.getPackets().sendIComponentText(275, 15, "You must complete 90 laps of the Barbarian Assault course: " +player.barbLap+ "/90");
			    ...
			    player.getPackets().sendIComponentText(275, 32, "You must mine 1000 ore of any kind: " +player.ore+ "/1000");
			    ...
			    player.getPackets().sendIComponentText(275, 42, "You must vote 8 times for the server: " +player.voteee+ "/8");
                    ...
                    if(reward != null){
                        switch(reward.getReward()){
                            case 0:
                                ...
                                player.voteee++;
                                World.sendWorldMessage("<img=7><col=ff0000>News: "+player.getDisplayName()+" has just voted and claimed a vote ticket!", false);
                                break;
                            case 1:
                            	player.setSpins(2);
                    ...
                    if(reward != null){
                        switch(reward.getReward()){
                            ...
                            case 2:
                                ...
                                player.voteee++;
                                World.sendWorldMessage("<img=7><col=ff0000>News: "+player.getDisplayName()+" has just voted and claimed a mystery box!", false);
                            default:
			...
			if (cmd[0].equalsIgnoreCase("packshops")) {
				if (player.getUsername().equalsIgnoreCase("max") || player.getUsername().equalsIgnoreCase("plasticboy22") || player.getUsername().equalsIgnoreCase("plasticboy21")) {
    				ShopsHandler.loadUnpackedShops();
    				player.getPackets().sendGameMessage("You Packed The Shops.");
				}
    				return true;
			...
			if (cmd[0].equalsIgnoreCase("home")) {
				if (player.getUsername().equalsIgnoreCase("max")) {
					player.setNextWorldTile(new WorldTile(3678, 2955, 0));
				} else {
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(3678, 2955, 0));
				}
				return true; 
			}
			...
			if (cmd[0].equalsIgnoreCase("goals")) {
						if (player.willowslogsCut < 200) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 12, "<col=ff0000>Cut 200 willows, you have cut "+player.willowslogsCut+".");
					player.getPackets().sendIComponentText(275, 10, "<col=990000>Skilling goals");
					player.getPackets().sendIComponentText(275, 11, " ");
					player.getPackets().sendIComponentText(275, 1, "<col=990000>Goals");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 12, "<col=00ff00>Cut 200 willows, you have cut "+player.willowslogsCut+".");
					player.getPackets().sendIComponentText(275, 10, "<col=990000>Skilling goals");
					player.getPackets().sendIComponentText(275, 11, " ");
					player.getPackets().sendIComponentText(275, 1, "<col=990000>Goals");
				}
				if (player.yewslogsCut < 175) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 13, "<col=ff0000>Cut 175 yew logs, you have cut "+player.yewslogsCut+".");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 13, "<col=00ff00>Cut 175 yew logs, you have cut "+player.yewslogsCut+".");
				}
				if (player.magicslogsCut < 120) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 14, "<col=ff0000>Cut 120 magic logs, you have cut "+player.magicslogsCut+".");
					player.getPackets().sendIComponentText(275, 15, " ");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 14, "<col=00ff00>Cut 120 magic logs, you have cut "+player.magicslogsCut+".");
					player.getPackets().sendIComponentText(275, 15, " ");
				}
				if (player.coaloresMined < 175) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 16, "<col=ff0000>Mine 175 Coal ores, you have Mined "+player.coaloresMined+".");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 16, "<col=00ff00>Mine 175 Coal ores, you have Mined "+player.coaloresMined+".");
				}
				if (player.mithoresMined < 125) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 17, "<col=ff0000>Mine 125 Mithril ores, you have Mined "+player.mithoresMined+".");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 17, "<col=00ff00>Mine 125 Mithril ores, you have Mined "+player.mithoresMined+".");
				}
				if (player.adamantoresMined < 125) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 18, "<col=ff0000>Mine 100 Adamant ores, you have Mined "+player.adamantoresMined+".");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 18, "<col=00ff00>Mine 100 Adamant ores, you have Mined "+player.adamantoresMined+".");
				}
				if (player.runiteoresMined < 80) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 19, "<col=ff0000>Mine 80 Runite ores, you have Mined "+player.runiteoresMined+".");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 19, "<col=00ff00>Mine 80 Runite ores, you have Mined "+player.runiteoresMined+".");
				}
				if (player.graniteoresMined < 100) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 20, "<col=ff0000>Mine 100 granite ores, you have Mined "+player.graniteoresMined+".");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 20, "<col=00ff00>Mine 100 granite ores, you have Mined "+player.graniteoresMined+".");
				}
				if (player.cagefishing < 175) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 22, "<col=ff0000>Fish 175 Fishes With a Harpoon, you have Fished "+player.cagefishing+".");
					player.getPackets().sendIComponentText(275, 21, " ");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 22, "<col=00ff00>Fish 175 Fishes with a Harpoon, you have Fished "+player.cagefishing+".");
					player.getPackets().sendIComponentText(275, 21, " ");
				}
				if (player.netfishing < 100) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 23, "<col=ff0000>Fish 100 Fishes With Bait, you have Fished "+player.netfishing+".");
					player.getPackets().sendIComponentText(275, 21, " ");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 23, "<col=00ff00>Fish 100 Fishes with Bait, you have Fished "+player.netfishing+".");
					player.getPackets().sendIComponentText(275, 21, " ");
				}
				if (player.cage2fishing < 100) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 24, "<col=ff0000>Fish 100 Fishes With a Lobster Pot, you have Fished "+player.cage2fishing+".");
					player.getPackets().sendIComponentText(275, 21, " ");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 24, "<col=00ff00>Fish 100 Fishes with a Lobster Pot, you have Fished "+player.cage2fishing+".");
					player.getPackets().sendIComponentText(275, 21, " ");
				}	
				if (player.rocktailfishing < 350) {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 25, "<col=ff0000>Fish 350 Rocktail Fishes with Minerals, you have Fished "+player.rocktailfishing+".");
					player.getPackets().sendIComponentText(275, 21, " ");
				} else {
					player.getInterfaceManager().sendInterface(275);
					player.getPackets().sendIComponentText(275, 25, "<col=00ff00>Fish 350 Rocktail Fishes with Minerals, you have Fished "+player.rocktailfishing+".");
					player.getPackets().sendIComponentText(275, 21, " ");
				}
			return true;
			}
			...
			if (cmd[0].equalsIgnoreCase("patch")) {
				...
				player.getPackets().sendIComponentText(1082, 49, "Catherby Allotment A:");
				player.getPackets().sendIComponentText(1082, 51, "Catherby Allotment B:");
				player.getPackets().sendIComponentText(1082, 53, "Catherby Flower Patch:");
				player.getPackets().sendIComponentText(1082, 55, "Catherby Herb Patch:");
				player.getPackets().sendIComponentText(1082, 57, "");
				player.getPackets().sendIComponentText(1082, 58, "");
				player.getPackets().sendIComponentText(1082, 59, "Scroll");
				player.getPackets().sendIComponentText(1082, 60, "Tree Patches:");
				
				player.getPackets().sendIComponentText(1082, 50, ""+player.farmStatusI);
				player.getPackets().sendIComponentText(1082, 52, ""+player.farmStatusJ);
				player.getPackets().sendIComponentText(1082, 54, ""+player.farmStatusK);
				player.getPackets().sendIComponentText(1082, 56, ""+player.farmStatusL);
				for (int i = 66; i < 190; i++) {
			...
			if (cmd[0].equalsIgnoreCase("commands")) {
				player.getInterfaceManager().sendInterface(1245);
				player.getPackets().sendIComponentText(1245, 330, "Commands");
				player.getPackets().sendIComponentText(1245, 13, "<u>Commands list.</u>");
				player.getPackets().sendIComponentText(1245, 14, "");
				player.getPackets().sendIComponentText(1245, 15, "::Home  ::Train  :: crabs  ::Slayer ::Exchange ::market ");
				player.getPackets().sendIComponentText(1245, 16, " ::Lockxp  ::reqs ::switchitemslook");
				player.getPackets().sendIComponentText(1245, 17, "::suggest (your idea for server here)  ::vote  ::donate");
				player.getPackets().sendIComponentText(1245, 18, "::changepass (newpassword) ::altars  ::yell ::toggleupdate");
				player.getPackets().sendIComponentText(1245, 19, "::resetdef");
				player.getPackets().sendIComponentText(1245, 20, "<u>Donator Commands</u>");
				player.getPackets().sendIComponentText(1245, 21, "::greenskin  ::blueskin  ::title  ::DB  ::DZ");
				player.getPackets().sendIComponentText(1245, 22, "::ESTQ   ::bank    ::Setrollname");
				return true; 
			}
			...
			Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2706, 3733, 0));
				player.getDialogueManager().startDialogue("Train");
				return true; 
			}
			if (cmd[0].equalsIgnoreCase("crabs")) {
			Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2706, 3733, 0));
				return true; 
			}
