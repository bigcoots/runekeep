...
public class House {
	...
	public House() {		
		...
		rooms.add(new RoomReference(Room.QuestHall, 5, 5, 0, 2));
		rooms.add(new RoomReference(Room.COMBATRING, 6, 3, 0, 1));
		rooms.add(new RoomReference(Room.BEDROOM, 6, 4, 0, 1));
		rooms.add(new RoomReference(Room.DININGROOM, 6, 5, 0, 1));
		rooms.add(new RoomReference(Room.WorkShop, 5, 3, 0, 1));
		place = 0; //desert
		look = 5; //idk style
	}
	...
	public static enum Room {
		...
		QuestHall(245, 638, false, RegionBuilder.NORTH, RegionBuilder.EAST, RegionBuilder.SOUTH, RegionBuilder.WEST),
		Chapel(234, 637, false, RegionBuilder.NORTH, RegionBuilder.EAST, RegionBuilder.SOUTH, RegionBuilder.WEST),
        COMBATRING(238, 635, false, RegionBuilder.NORTH, RegionBuilder.EAST, RegionBuilder.SOUTH, RegionBuilder.WEST);		
