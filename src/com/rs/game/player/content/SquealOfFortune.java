...
import com.rs.utils.Utils;
 ...
 public class SquealOfFortune {
	...
	private static Item[] SUPER_RARE_ITEM = { new Item(995, 50000000), new Item(995, 25000000), new Item(24437, 1), new Item(20929, 1),
	new Item(23674) 
	};
 
	private static Item[] RARE_SLOT1 = { new Item(4151), new Item(4224, 1), new Item(4151),
	new Item(4151), new Item(4212, 1), new Item(4151), new Item(6541, 1) 
	},
	...
	UNCOMMON_SLOT3 = { new Item(12976), new Item(1133)
	};
    ...
    || player.getBox().getName().contains("Lucky")
	  || player.getBox().getName().contains("mouse")
	   || player.getBox().getName().contains("crystal") 
	) {
