...
public class FarmingCutScene extends Cutscene {
	...
	public CutsceneAction[] getActions(Player player) {
		...
		player.getDialogueManager().startDialogue("SimpleMessage", "This is one of the farming locations located around Validus, to start farming you must have a rake in your inventory, simply click the farming allotment to start raking.");
