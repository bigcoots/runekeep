...
import com.rs.game.player.content.clans.clancitadels.CitadelControler;
...
public class ControlerHandler {
	...
	public static final void init() {
		try {
			...
			handledControlers.put("QuizEvent", (Class<Controler>) Class.forName(QuizEvent.class.getCanonicalName()));
handledControlers.put("RecipeforDisaster", (Class<Controler>) Class.forName(RecipeforDisaster.class.getCanonicalName()));
	handledControlers.put("dung", (Class<Controler>) Class.forName(dung.class.getCanonicalName()));			
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
