...
public class InterfaceManager {
	...
	public void sendTaskSystem() {
        ...
        player.getPackets().sendIComponentText(506, 6, "add something");
        ...
        player.getPackets().sendIComponentText(506, 2, "        Control Panel       <img=1><shad=FFFF00>Admin</shad>");
	        ...
	        player.getPackets().sendIComponentText(1019, 16,  "Suggest/Report");
	        player.getPackets().sendIComponentText(1019, 18,  "Submit a Ticket");
	        player.getPackets().sendIComponentText(1019, 11,  " ");
	        player.getPackets().sendIComponentText(1019, 0,  "Anything to say? Report it here!");
	        player.getPackets().sendIComponentText(1019, 8,  "Submit a ticket to an online staff member ");
		}
    }
