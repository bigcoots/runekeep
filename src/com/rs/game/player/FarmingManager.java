...
public class FarmingManager {
	...
	public static void plantTomatoA(final Player player, final int configId) {
	...
	public static void plantTomatoB(final Player player, final int configId) {
		if (player.getInventory().containsItem(5322, 1)) {
		WorldTasksManager.schedule(new WorldTask() {
			int loop;
			@Override
	...
	public static void plantOnionA(final Player player, final int configId) {
	...
	public static void plantOnionB(final Player player, final int configId) {
		if (player.getInventory().containsItem(5319, 1)) {
		WorldTasksManager.schedule(new WorldTask() {
			int loop;
			@Override
	...
	public static void plantCabbageA(final Player player, final int configId) {
	...
	public static void plantCabbageB(final Player player, final int configId) {
		if (player.getInventory().containsItem(5324, 1)) {
		WorldTasksManager.schedule(new WorldTask() {
			int loop;
			@Override
	...
	public static void plantStrawberryA(final Player player, final int configId) {
	...
	public static void plantStrawberryB(final Player player, final int configId) {
		if (player.getInventory().containsItem(5323, 1)) {
		WorldTasksManager.schedule(new WorldTask() {
			int loop;
			@Override
	...
	public static void plantMarren(final Player player, final int configId) {
		...
		public static void plantTarrom(final Player player, final int configId) {
		...
		public static void plantHarra(final Player player, final int configId) {
		...
		public static void plantRannar(final Player player, final int configId) {
		...
		public static void plantToad(final Player player, final int configId) {
		...
		public static void plantIrit(final Player player, final int configId) {
		...
		public static void plantWerg(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.getPackets().sendConfigByFile(configId, 62);
					player.out("<col=FF0000>[Notice] Your herbs are half way done at Falador.</col>");
				} else if (loop == 240) {	
					player.getPackets().sendConfigByFile(configId, 64);
					player.out("<col=FF0000>[Notice] Your herbs are fully grown at Falador.</col>");
					player.canHarvestHerbA = true;
					player.farmingStatusH = 3;
				}
		...
		public static void plantAvant(final Player player, final int configId) {
		...
		public static void plantKwuarm(final Player player, final int configId) {
		...
		public static void plantCadan(final Player player, final int configId) {
		...
		public static void plantLant(final Player player, final int configId) {
		...
		public static void plantDwarf(final Player player, final int configId) {
		...
		public static void plantFell(final Player player, final int configId) {
		...
		public static void plantGoat(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.farmStatus();
					player.setNextAnimation(new Animation(2291));
					player.getPackets().sendConfigByFile(configId, 192);
					player.getInventory().deleteItem(3261, 1);
				} else if (loop == 120) {
					player.getPackets().sendConfigByFile(configId, 194);
					player.out("<col=FF0000>[Notice] Your herbs are half way done at Falador.</col>");
				} else if (loop == 240) {	
					player.getPackets().sendConfigByFile(configId, 196);
					player.out("<col=FF0000>[Notice] Your herbs are fully grown at Falador.</col>");
					player.canHarvestHerbA = true;
					player.farmingStatusH = 3;
				}
	...
	public static void plantNast(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.getPackets().sendConfigByFile(configId, 20);
					player.out("<col=FF0000>[Notice] Your Nasturtium are half way done at Falador.</col>");
				} else if (loop == 240) {	
					player.getPackets().sendConfigByFile(configId, 22);
					player.out("<col=FF0000>[Notice] Your Nasturtium Seeds have fully grown at Falador.</col>");
					player.canHarvestFlowerA = true;
					player.farmingStatusF = 3;
				}
					loop++;
				...
				player.out("You'll need some Nasturtium seeds.");
			}
	}
	
	public static void plantRose(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.getPackets().sendConfigByFile(configId, 15);
					player.out("<col=FF0000>[Notice] Your Rosemary are half way done at Falador.</col>");
				} else if (loop == 240) {	
					player.getPackets().sendConfigByFile(configId, 17);
					player.out("<col=FF0000>[Notice] Your Rosemary have fully grown at Falador.</col>");
					player.canHarvestFlowerA = true;
					player.farmingStatusF = 3;
				}
					loop++;
	...
	public static void plantWoad(final Player player, final int configId) {
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				if (loop == 0) {
					...
					player.out("<col=FF0000>[Notice] Your Woad Seeds are half way done at Falador.</col>");
				} else if (loop == 240) {	
					player.getPackets().sendConfigByFile(configId, 27);
					player.out("<col=FF0000>[Notice] Your Woad Seeds have fully grown at Falador.</col>");
					player.canHarvestFlowerA = true;
					player.farmingStatusF = 3;
				}
					loop++;
