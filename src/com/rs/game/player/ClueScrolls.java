...
public class ClueScrolls {
	...
	private enum Maps {
		...
		Map2(338,3021,3912,"Inbetween a lava blaze and a near Deathly Agility Course!"),
		Map3(339,2722,3339,"South of where legends may be placed, and east of great thieving!"),
		Map4(341,3435,3265,"South of a mucky mucky mucky mucky swamp lands, and barely north of Haunted Mines!"),
	...
	static Item[] ThirdAge = {new Item(10330),new Item(10332),new Item(10334),new Item(10336),new Item(10338),new Item(10340),new Item(10342),new Item(10344),new Item(10346),new Item(10348),new Item(10350),new Item(10352),new Item(19308),new Item(19311),new Item(19314),new Item(19317),new Item(19320)};    
	...
	public static void giveReward(Player p){
		...
		if (random > 875){
			...
			p.getPackets().sendGameMessage("Congratulations!");			
			p.getInventory().deleteItem(2717,1);
