...
public final class EmotesManager implements Serializable {
	...
	public void useBookEmote(int id) {
		...
		if (!unlockedEmotes.contains(id) && player.getRights() < 2) {
			...
			if (id == 2) {
				player.setNextAnimation(new Animation(855)); //yes
			} else if (id == 3) {
				player.setNextAnimation(new Animation(856)); //no
			} else if (id == 4) {
				player.setNextAnimation(new Animation(858)); //bow
			} else if (id == 5) {
				player.setNextAnimation(new Animation(859)); //angry
			} else if (id == 6) {
				player.setNextAnimation(new Animation(857)); //think
			} else if (id == 7) {
				player.setNextAnimation(new Animation(863)); //wave
			} else if (id == 8) {
				player.setNextAnimation(new Animation(2113)); //shrug
			} else if (id == 9) {
				player.setNextAnimation(new Animation(862)); //cheer
			} else if (id == 10) {
				player.setNextAnimation(new Animation(864)); //beckon
			} else if (id == 12) {
				player.setNextAnimation(new Animation(861)); //laught
			} else if (id == 11) {
				player.setNextAnimation(new Animation(2109)); //jump for joy
			} else if (id == 13) {
				player.setNextAnimation(new Animation(2111)); //jawn
			} else if (id == 14) {
				player.setNextAnimation(new Animation(866)); //dance
			} else if (id == 15) {
				player.setNextAnimation(new Animation(2106)); //jig
			} else if (id == 16) {
				player.setNextAnimation(new Animation(2107)); //twirl
			} else if (id == 17) {
				player.setNextAnimation(new Animation(2108)); //headbang
			} else if (id == 18) {
				player.setNextAnimation(new Animation(860)); //cry
			} else if (id == 19) {
				player.setNextAnimation(new Animation(1374)); //blow kiss
				player.setNextGraphics(new Graphics(1702)); //blow kiss
			} else if (id == 20) {
				player.setNextAnimation(new Animation(2105)); //panic
			} else if (id == 21) {
				player.setNextAnimation(new Animation(2110)); //raspberry
			} else if (id == 22) {
				player.setNextAnimation(new Animation(865)); //clap
			} else if (id == 23) {
				player.setNextAnimation(new Animation(2112)); //salute
			} else if (id == 24) {
				player.setNextAnimation(new Animation(0x84F)); //goblin bow
			} else if (id == 25) {
				player.setNextAnimation(new Animation(0x850)); //goblin salute
			} else if (id == 26) {
				player.setNextAnimation(new Animation(1131)); //glass box
			} else if (id == 27) {
				player.setNextAnimation(new Animation(1130)); //climb rope
			} else if (id == 28) {
				player.setNextAnimation(new Animation(1129)); //lean
			} else if (id == 29) {
				player.setNextAnimation(new Animation(1128)); //glass wall
			} else if (id == 30) {
				player.setNextAnimation(new Animation(4275)); //idea
			} else if (id == 31) {
				player.setNextAnimation(new Animation(1745)); //stomp
			} else if (id == 32) {
				player.setNextAnimation(new Animation(4280)); //flap
			} else if (id == 33) {
				player.setNextAnimation(new Animation(4276)); //slap head
			} else if (id == 34) {
				player.setNextAnimation(new Animation(3544)); //zombie walk
			} else if (id == 35) {
				player.setNextAnimation(new Animation(3543)); //zombie dance
			} else if (id == 36) {
				player.setNextAnimation(new Animation(7272)); //zombie hand
				player.setNextGraphics(new Graphics(1244)); //zombie hand
			} else if (id == 37) {
				player.setNextAnimation(new Animation(2836)); //scared
			} else if (id == 38) {
				player.setNextAnimation(new Animation(6111)); //bunny-hop
			} else if (id == 39) {
				// TODO skillCape
				...
				case 21406: // battlefield cape
					player.setNextAnimation(new Animation(8990));
					player.setNextGraphics(new Graphics(2845));
				    break;	
				case 21407: // battlefield cape
					player.setNextAnimation(new Animation(10018));
					player.setNextGraphics(new Graphics(2029));
				    break;
				case 21408: // battlefield cape
				...
				case 24317: // monkey cape
				    ...
				    break;
				case 12645: // choco cape
					player.setNextAnimation(new Animation(528));
					player.setNextGraphics(new Graphics(1333));
				    break;
				case 21435: // herald cape
					player.setNextAnimation(new Animation(513));
					player.setNextGraphics(new Graphics(91));
				    break;
				case 24299: // cape of validation
					player.setNextAnimation(new Animation(1110));
					player.setNextGraphics(new Graphics(2953));
				    break;

				case 20754: // milestone cape
					player.setNextAnimation(new Animation(9095));
					player.setNextGraphics(new Graphics(1366));
					break;
				case 20755: // milestone cape
					player.setNextAnimation(new Animation(3170));				
					player.setNextGraphics(new Graphics(1196));
					break;
				case 20756: // milestone cape
					player.setNextAnimation(new Animation(15526));
					player.setNextGraphics(new Graphics(1194));
					break;
				case 20757: // milestone cape
					player.setNextAnimation(new Animation(2876));
					player.setNextGraphics(new Graphics(2980));
					break;
				case 20758: // milestone cape
					player.setNextAnimation(new Animation(2890));
					player.setNextGraphics(new Graphics(3090));
					break;
				case 20759: // milestone cape
					player.setNextAnimation(new Animation(1902));
					player.setNextGraphics(new Graphics(2994));
					break;
				case 20761: // milestone cape
					player.setNextAnimation(new Animation(15458));
					player.setNextGraphics(new Graphics(2437));
					break;
				case 20760: // milestone cape
					player.setNextAnimation(new Animation(15184));
					player.setNextGraphics(new Graphics(3397));
					break;					
				case 20762: // milestone cape
					player.setNextAnimation(new Animation(12929));
					player.setNextGraphics(new Graphics(3396));
					break;	
				...
				player.setNextAnimation(new Animation(7531)); //snowman dance
			} else if (id == 41) {
				player.setNextAnimation(new Animation(2414)); //air guitar
				player.setNextGraphics(new Graphics(1537)); //air guitar
				player.getPackets().sendMusicEffect(302); //air guitar
			} else if (id == 42) {
				player.setNextAnimation(new Animation(8770)); //safety first
				player.setNextGraphics(new Graphics(1553)); //safety first
			} else if (id == 43) {
				player.setNextAnimation(new Animation(9990)); //explore
				player.setNextGraphics(new Graphics(1734)); //explore
			} else if (id == 44) {
				player.setNextAnimation(new Animation(10530)); //trick
				player.setNextGraphics(new Graphics(1864)); //trick
			} else if (id == 45) {
				player.setNextAnimation(new Animation(11044)); //freeze
				player.setNextGraphics(new Graphics(1973)); //freeze
			...
			if (id == 52) {// Seal Of Approval
				...
				player.setNextAnimation(new Animation(11542)); //around the world in eggty days
				player.setNextGraphics(new Graphics(2037));
			} else if (id == 48) {
                player.setNextAnimation(new Animation(12658)); //dramatic point	
                player.setNextGraphics(new Graphics(780)); //dramatic point
                        } else if (id == 49) {
                                player.setNextAnimation(new Animation(14165)); //faint
			} else if(id == 50) {
				player.setNextAnimation(new Animation(14869)); //puppet master
				player.setNextGraphics(new Graphics(2837));
			} else if(id == 51) {
                player.setNextAnimation(new Animation(15034)); //taskmaster
                player.setNextGraphics(new Graphics(2930)); //taskmaster
			/*} else if(id == 52) {
				player.setNextAnimation(new Animation(2416));*/
			} else if(id == 53) {
				player.setNextAnimation(new Animation(2303)); //catfight
			} else if(id == 54) {
				player.setNextAnimation(new Animation(2312)); //talk to the hand
			} else if(id == 55) {
