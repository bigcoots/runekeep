	...
	public void start() {
		...
		sendEntityDialogue(SEND_2_TEXT_CHAT,
				new String[] { NPCDefinitions.getNPCDefinitions(npcId).name,
						"Hello! I can teleport you to all skilling areas on Validus,",
	...
	public void run(int interfaceId, int componentId) {
		if (stage == -1) {
			...
			if (componentId == OPTION_1) {
							stage = 6;
				sendOptionsDialogue("Where would you like to go?",
						"Falador Farming", "Tree farm", "Ardougne farm",
						"Catherby farm");
				...
				stage = 5;
				sendOptionsDialogue("Where would you like to go?",
						"Abyss (Runecrafting)", "Dungeoneering (BETA)", "Summoning",
			...
			if (componentId == OPTION_1) {
				...
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2926, 3448, 0));
			...
			if (componentId == OPTION_1) {
				...
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(3002, 3375, 0));				
			}	 else if (componentId == OPTION_3) {
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2663, 3375, 0));
			} else if (componentId == OPTION_4) {
				Magic.sendNormalTeleportSpell(player, 0, 0, new WorldTile(2806, 3464, 0));
