...
public final class LevelUp extends Dialogue {
	...
	public void start() {
		...
		player.getPackets().sendGameMessage(
				"<col=ff0000>You have gained some tokens for your hard work, you now have "+player.LevelTokens+" Level Tokens!");
		player.getPackets().sendGameMessage(
				"<col=ff0000>Spend these at the Level Shop at home for useful items and cool Costumes!");
			player.LevelTokens+= 1;
		player.getPackets().sendGameMessage(
