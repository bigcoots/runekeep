...
public class Cape extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (componentId == OPTION_1) {
		    ...
		    player.getPackets().sendIComponentText(275, 42, "You must have completed the fight caves.");
		    player.getPackets().sendIComponentText(275, 43, "You must have killed QBD");
