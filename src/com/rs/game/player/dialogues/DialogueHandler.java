		...
		try {
			...
			Class<Dialogue> value5 = (Class<Dialogue>) Class
					.forName(DestroyItemOption.class.getCanonicalName());
                        handledDialogues.put("LargeLamp", (Class<Dialogue>) Class.forName(LargeLamp.class.getCanonicalName()));
			...
			Class<Dialogue> value88 = (Class<Dialogue>) Class
					.forName(Clan.class.getCanonicalName());
			handledDialogues.put("Clan", value88);
			...
			handledDialogues.put("Clan", (Class<Dialogue>) Class.forName(Clan.class.getCanonicalName()));
                        handledDialogues.put("ClanCreation", (Class<Dialogue>) Class.forName(ClanCreation.class.getCanonicalName()));
			...
			handledDialogues.put("pestreward", (Class<Dialogue>) Class.forName(pestreward.class.getCanonicalName()));	
			handledDialogues.put("bossreward", (Class<Dialogue>) Class.forName(bossreward.class.getCanonicalName()));				
			...
			handledDialogues.put("Thessalia", (Class<Dialogue>) Class.forName(Thessalia.class.getCanonicalName()));
					handledDialogues.put("Plank", (Class<Dialogue>) Class.forName(Plank.class.getCanonicalName()));	
						handledDialogues.put("Lever", (Class<Dialogue>) Class.forName(Lever.class.getCanonicalName()));
				...
				handledDialogues.put("MakePortal", (Class<Dialogue>) Class.forName(MakePortal.class.getCanonicalName()));
					...
					handledDialogues.put("MakeStair", (Class<Dialogue>) Class.forName(MakeStair.class.getCanonicalName()));	
					handledDialogues.put("MakeLamp", (Class<Dialogue>) Class.forName(MakeLamp.class.getCanonicalName()));	
						handledDialogues.put("MakeWindow", (Class<Dialogue>) Class.forName(MakeWindow.class.getCanonicalName()));	
						handledDialogues.put("MakeIcon", (Class<Dialogue>) Class.forName(MakeIcon.class.getCanonicalName()));
						handledDialogues.put("MakeMusical", (Class<Dialogue>) Class.forName(MakeMusical.class.getCanonicalName()));	
						handledDialogues.put("MakeStatue", (Class<Dialogue>) Class.forName(MakeStatue.class.getCanonicalName()));
						handledDialogues.put("MakeGarden", (Class<Dialogue>) Class.forName(MakeGarden.class.getCanonicalName()));
						handledDialogues.put("MakeLever", (Class<Dialogue>) Class.forName(MakeLever.class.getCanonicalName()));
					handledDialogues.put("MakeTrapdoor", (Class<Dialogue>) Class.forName(MakeTrapdoor.class.getCanonicalName()));
					handledDialogues.put("MakeFloor", (Class<Dialogue>) Class.forName(MakeFloor.class.getCanonicalName()));
					handledDialogues.put("MakeBench", (Class<Dialogue>) Class.forName(MakeBench.class.getCanonicalName()));
					handledDialogues.put("MakeDecoration", (Class<Dialogue>) Class.forName(MakeDecoration.class.getCanonicalName()));
					handledDialogues.put("MakeFocus", (Class<Dialogue>) Class.forName(MakeFocus.class.getCanonicalName()));		
					handledDialogues.put("MakeSword", (Class<Dialogue>) Class.forName(MakeSword.class.getCanonicalName()));		
					handledDialogues.put("MakeBell", (Class<Dialogue>) Class.forName(MakeBell.class.getCanonicalName()));	
					handledDialogues.put("MakeSeat", (Class<Dialogue>) Class.forName(MakeSeat.class.getCanonicalName()));
					handledDialogues.put("MakeTable", (Class<Dialogue>) Class.forName(MakeTable.class.getCanonicalName()));	
					handledDialogues.put("MakeDeco", (Class<Dialogue>) Class.forName(MakeDeco.class.getCanonicalName()));
					handledDialogues.put("MakeDresser", (Class<Dialogue>) Class.forName(MakeDresser.class.getCanonicalName()));	
					handledDialogues.put("MakeBed", (Class<Dialogue>) Class.forName(MakeBed.class.getCanonicalName()));	
					handledDialogues.put("MakeWard", (Class<Dialogue>) Class.forName(MakeWard.class.getCanonicalName()));
					handledDialogues.put("MakeClock", (Class<Dialogue>) Class.forName(MakeClock.class.getCanonicalName()));	
					handledDialogues.put("MakeClockmaking", (Class<Dialogue>) Class.forName(MakeClockmaking.class.getCanonicalName()));	
					handledDialogues.put("MakeWorkbench", (Class<Dialogue>) Class.forName(MakeWorkbench.class.getCanonicalName()));	
					handledDialogues.put("MakeRepair", (Class<Dialogue>) Class.forName(MakeRepair.class.getCanonicalName()));
					handledDialogues.put("MakeHeraldry", (Class<Dialogue>) Class.forName(MakeHeraldry.class.getCanonicalName()));
					handledDialogues.put("MakeTools", (Class<Dialogue>) Class.forName(MakeTools.class.getCanonicalName()));	
					handledDialogues.put("MakeRug", (Class<Dialogue>) Class.forName(MakeRug.class.getCanonicalName()));		
					handledDialogues.put("MakeRug1", (Class<Dialogue>) Class.forName(MakeRug1.class.getCanonicalName()));	
					handledDialogues.put("MakeRug2", (Class<Dialogue>) Class.forName(MakeRug2.class.getCanonicalName()));	
					handledDialogues.put("MakeRug3", (Class<Dialogue>) Class.forName(MakeRug3.class.getCanonicalName()));
					handledDialogues.put("RandomEventShop", (Class<Dialogue>) Class.forName(RandomEventShop.class.getCanonicalName()));	
					handledDialogues.put("MakeGuard", (Class<Dialogue>) Class.forName(MakeGuard.class.getCanonicalName()));
					handledDialogues.put("MakeLadder", (Class<Dialogue>) Class.forName(MakeLadder.class.getCanonicalName()));
					handledDialogues.put("MakeFirefloor", (Class<Dialogue>) Class.forName(MakeFirefloor.class.getCanonicalName()));	
					handledDialogues.put("MakeCage", (Class<Dialogue>) Class.forName(MakeCage.class.getCanonicalName()));						
			handledDialogues.put("GrilleGoatsD", (Class<Dialogue>) Class.forName(GrilleGoatsDialogue.class.getCanonicalName()));
			handledDialogues.put("Dungreward", (Class<Dialogue>) Class.forName(Dungreward.class.getCanonicalName()));
			handledDialogues.put("SummoningShop", (Class<Dialogue>) Class.forName(SummoningShop.class.getCanonicalName()));	
			handledDialogues.put("Lodefala", (Class<Dialogue>) Class.forName(Lodefala.class.getCanonicalName()));			
			handledDialogues.put("LodeSarim", (Class<Dialogue>) Class.forName(LodeSarim.class.getCanonicalName()));	
			handledDialogues.put("Lodedraynor", (Class<Dialogue>) Class.forName(Lodedraynor.class.getCanonicalName()));	
			handledDialogues.put("LodeVarrock", (Class<Dialogue>) Class.forName(LodeVarrock.class.getCanonicalName()));	
			handledDialogues.put("Lodeedge", (Class<Dialogue>) Class.forName(Lodeedge.class.getCanonicalName()));	
			handledDialogues.put("Lodetav", (Class<Dialogue>) Class.forName(Lodetav.class.getCanonicalName()));	
			handledDialogues.put("Lodeburth", (Class<Dialogue>) Class.forName(Lodeburth.class.getCanonicalName()));	
			handledDialogues.put("Lodecath", (Class<Dialogue>) Class.forName(Lodecath.class.getCanonicalName()));	
			handledDialogues.put("Lodeseers", (Class<Dialogue>) Class.forName(Lodeseers.class.getCanonicalName()));
			handledDialogues.put("LodeArdougne", (Class<Dialogue>) Class.forName(LodeArdougne.class.getCanonicalName()));
			handledDialogues.put("LodeYanille", (Class<Dialogue>) Class.forName(LodeYanille.class.getCanonicalName()));
			handledDialogues.put("LodeAlkarid", (Class<Dialogue>) Class.forName(LodeAlkarid.class.getCanonicalName()));	
			handledDialogues.put("Farmshop", (Class<Dialogue>) Class.forName(Farmshop.class.getCanonicalName()));
				handledDialogues.put("Runespannpc", (Class<Dialogue>) Class.forName(Runespannpc.class.getCanonicalName()));	
	handledDialogues.put("FloatingEssence", (Class<Dialogue>) Class.forName(FloatingEssence.class.getCanonicalName()));					
handledDialogues.put("Repair", (Class<Dialogue>) Class.forName(Repair.class.getCanonicalName()));	
handledDialogues.put("kill", (Class<Dialogue>) Class.forName(kill.class.getCanonicalName()));	
handledDialogues.put("QuizMaster", (Class<Dialogue>) Class.forName(QuizMaster.class.getCanonicalName()));
handledDialogues.put("FreakyForester", (Class<Dialogue>) Class.forName(FreakyForester.class.getCanonicalName()));
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
