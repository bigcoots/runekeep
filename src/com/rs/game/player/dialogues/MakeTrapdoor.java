...
public class MakeTrapdoor extends Dialogue {

	@Override
	public void start() {
			sendOptionsDialogue("What would you like to do?",
					"trapdoor(Costs 1M).", "Never mind.");
	}
