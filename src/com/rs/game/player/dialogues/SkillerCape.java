...
public class SkillerCape extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		if (componentId == OPTION_1) {
		    ...
		    player.getPackets().sendIComponentText(275, 38, "You must have stolen: " +player.thieve+ "/700 scimitars.");
		    player.getPackets().sendIComponentText(275, 35, "You must have completed: " +player.agility+ "/100 laps of the gnome agility course.");
