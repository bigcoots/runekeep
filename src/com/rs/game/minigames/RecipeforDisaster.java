 ...
 */
 ...
 player.getDialogueManager().startDialogue("SimpleNPCMessage", 3491, "You DARE come here !?! Say hello to my little friend!");
 ...
 */
 ...
 player.out("<col=00ff00> You've recieved some gloves in your bank");
 ...
 */
 ...
 if (getCurrentWave() == 5) 
 player.getDialogueManager().startDialogue("SimpleNPCMessage", 3491, "You have caused me enough grief! I guess I will have to finish you off myself!");
 CoresManager.fastExecutor.schedule(new TimerTask() {
 ...
 */
 ...
 if (players == null)
 continue;
 players.getPackets().sendGameMessage("<img=6><col= ff0066>News: "+player.getDisplayName()+" Just completed Recipe Of Disaster.");
	player.getInterfaceManager().sendPrayerBook();
 }
player.out("<col=00ff00> You've recieved some gloves in your bank");
 canpray = false;
