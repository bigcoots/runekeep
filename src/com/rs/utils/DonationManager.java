...
public class DonationManager {
    ...
    public static void createConnection() {
        ...
        String IP="31.220.17.48";
        String DB="proje990_database";
        String User="proje990";
        String Pass="killerjens9"; 
        ...
        if(checkDonation(player.getUsername())) {
            ...
            */
            if(checkDonationItem(player.getUsername()) == 1) { //Productid 1 
                ...
                player.getPackets().sendGameMessage("Enjoy your donation, thank you for donating!!");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=1>" + player.getUsername() + " has donated, tell him thanks for contributing!<img=1>");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=1>Donate at validus.net!<img=1>");
                    }
                }
          ...
          if(checkDonationItem(player.getUsername()) == 5) { //Productid 5
                ...
                player.getInventory().addItem(1057, 1);
                    ...
                    player.getPackets().sendGameMessage("Enjoy Your Donation, Thanks for Donating!!");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=1>" + player.getUsername() + "has donated tell him thanks for contributing!<img=1>");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=1Donate at validus.net!<img=1>");
                    }
                donationGiven(player.getUsername());        
            }
            ...
            if(checkDonationItem(player.getUsername()) == 11) { //Productid 11 
                player.getPackets().sendGameMessage("<shad=cc0ff><img=12>You Have Received : Super Donator!");
                player.getPackets().sendGameMessage("<col=00FFCC>The donatorzone can be found by the command ::dz");
                if (!player.isDonator()) {
                    player.setDonator(true);
                if (!player.isSuperDonator()) {
                    ...
                    player.getPackets().sendGameMessage("Enjoy Your Donation, Thanks for Donating!!");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=12>" + player.getUsername() + " has donated and received Super Donator Rank!<img=12>");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=8>Donate at validus.net!<img=8>");
                    }
                }
                }
                donationGiven(player.getUsername());        
            }
            if(checkDonationItem(player.getUsername()) == 12) { //Productid 12 
                player.getPackets().sendGameMessage("<shad=cc0ff><img=12>You Have Received : Loyalty Points!");
               player.setLoyaltyPoints(player.getLoyaltyPoints() + 50000);
                    ...
                    player.getPackets().sendGameMessage("Enjoy Your Donation, Thanks for Donating!!");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=12>" + player.getUsername() + " has donated and received Loyalty Points!<img=12>");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=8>Donate at validus.net!<img=8>");
                }
                donationGiven(player.getUsername());        
            }
            if(checkDonationItem(player.getUsername()) == 13) { //Productid 13 
                player.getPackets().sendGameMessage("<shad=cc0ff><img=12>You Have Received : 99 Lamp!");
                player.getInventory().addItem(23715, 1);
                    ...
                    player.getPackets().sendGameMessage("Enjoy Your Donation, Thanks for Donating!!");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=12>" + player.getUsername() + " has donated!<img=12>");
                p.getPackets().sendGameMessage("<shad=cc0ff><img=8>Donate at validus.net!<img=8>");
                }
                donationGiven(player.getUsername());        
            }
