...
import com.rs.game.minigames.dung;
...
public final class ObjectHandler {
	...
	private static void handleOption1(final Player player, final WorldObject object) {
		...
		player.setCoordsEvent(new CoordsEvent(object, new Runnable() {
			...
			public void run() {
				...
				if (id == 12683) {
                                if (player.getBank().containsItem(20708, 1)) {
                                   player.getPackets().sendGameMessage("You already have a clan cloak in your bank");
                                   return;
                                } else 
                                if (player.getInventory().containsItem(20708, 1)) {
                                   player.getPackets().sendGameMessage("You already have a clan cloak in your inventory");
                                   return;
                                } else
					player.getInventory().addItem(20708, 1);
				}
				if (id == 50342 || id ==  50346 || id == 50347 || id == 3724 || id == 49504 || id == 49650) {
					if (player.getX() == 113 && player.getY() == 4294 || player.getX() == 113 && player.getY() == 4295 || player.getX() == 113 && player.getY() == 4296 || player.getX() == 113 && player.getY() == 4297) {
						player.setNextWorldTile(new WorldTile(110, 4295, 0));
					}
					if (player.getX() == 126 && player.getY() == 4294 || player.getX() == 126 && player.getY() == 4295 || player.getX() == 126 && player.getY() == 4296 || player.getX() == 126 && player.getY() == 4297) {
						player.setNextWorldTile(new WorldTile(129, 4295, 0));
					}
					if (player.getX() == 118 && player.getY() == 4286 || player.getX() == 119 && player.getY() == 4286 || player.getX() == 120 && player.getY() == 4286 || player.getX() == 121 && player.getY() == 4286) {
						player.setNextWorldTile(new WorldTile(120, 4289, 0));
					}
					if (player.getX() == 121 && player.getY() == 4289 || player.getX() == 120 && player.getY() == 4289 || player.getX() == 119 && player.getY() == 4289 || player.getX() == 118 && player.getY() == 4289) {
					    player.setNextWorldTile(new WorldTile(119, 4286, 0));
					}
					if (player.getX() == 110 && player.getY() == 4297 || player.getX() == 110 && player.getY() == 4296 || player.getX() == 110 && player.getY() == 4295 || player.getX() == 110 && player.getY() == 4294) {
						player.setNextWorldTile(new WorldTile(113, 4295, 0));
					}
					if (player.getX() == 129 && player.getY() == 4294 || player.getX() == 129 && player.getY() == 4295 || player.getX() == 129 && player.getY() == 4296 || player.getX() == 129 && player.getY() == 4297) {
						player.setNextWorldTile(new WorldTile(126, 4296, 0));
					}
					if (player.getX() == 113 && player.getY() == 4278 || player.getX() == 113 && player.getY() == 4279 || player.getX() == 113 && player.getY() == 4280 || player.getX() == 113 && player.getY() == 4281) {
						player.getPackets().sendGameMessage("You have to find another way around this.");
					}
					if (player.getX() == 121 && player.getY() == 4273 || player.getX() == 120 && player.getY() == 4273 || player.getX() == 119 && player.getY() == 4273 || player.getX() == 118 && player.getY() == 4273) {
						player.setNextWorldTile(new WorldTile(120, 4270, 0));
					}
					if (player.getX() == 134 && player.getY() == 4289 || player.getX() == 135 && player.getY() == 4289 || player.getX() == 136 && player.getY() == 4289 || player.getX() == 137 && player.getY() == 4289) {
						player.setNextWorldTile(new WorldTile(136, 4286, 0));
					}
					if (player.getX() == 105 && player.getY() == 4289 || player.getX() == 104 && player.getY() == 4289 || player.getX() == 103 && player.getY() == 4289 || player.getX() == 102 && player.getY() == 4289) {
						player.setNextWorldTile(new WorldTile(103, 4286, 0));
					}
					if (player.getX() == 102 && player.getY() == 4286 || player.getX() == 103 && player.getY() == 4286 || player.getX() == 104 && player.getY() == 4286 || player.getX() == 105 && player.getY() == 4286) {
						player.setNextWorldTile(new WorldTile(103, 4289, 0));
					}
					if (player.getX() == 135 && player.getY() == 4286 || player.getX() == 136 && player.getY() == 4286) {
						player.setNextWorldTile(new WorldTile(135, 4289, 0));
					}
					if (player.getX() == 102 && player.getY() == 4273 || player.getX() == 103 && player.getY() == 4273 || player.getX() == 104 && player.getY() == 4273 || player.getX() == 105 && player.getY() == 4273) {
						player.setNextWorldTile(new WorldTile(103, 4270, 0));
					}	
					if (player.getX() == 102 && player.getY() == 4270 || player.getX() == 103 && player.getY() == 4270 || player.getX() == 104 && player.getY() == 4270 || player.getX() == 105 && player.getY() == 4270) {
						player.setNextWorldTile(new WorldTile(103, 4273, 0));
					}
					if (player.getX() == 134 && player.getY() == 4273 || player.getX() == 135 && player.getY() == 4273 || player.getX() == 136 && player.getY() == 4273) {
						player.setNextWorldTile(new WorldTile(135, 4270, 0));
					}
					if (player.getX() == 134 && player.getY() == 4270 || player.getX() == 135 && player.getY() == 4270 || player.getX() == 136 && player.getY() == 4270 || player.getX() == 137 && player.getY() == 4270) {
						player.setNextWorldTile(new WorldTile(136, 4273, 0));
					}	
					if (player.getX() == 118 && player.getY() == 4270 || player.getX() == 119 && player.getY() == 4270 || player.getX() == 1120 && player.getY() == 4270 || player.getX() == 121 && player.getY() == 4270) {
						player.setNextWorldTile(new WorldTile(136, 4273, 0));
					}
				}
				if (id == 6 || id == 29408) {
				...
				if (id == 55762) {
					if (player.getX() == 983 && player.getY() == 1121 || player.getX() == 984 && player.getY() == 1121) {
						player.setNextWorldTile(new WorldTile(983, 1117, 0));
					}
					if (player.getX() == 983 && player.getY() == 1117 || player.getX() == 984 && player.getY() == 1117) {
						player.setNextWorldTile(new WorldTile(984, 1121, 0));
					}
					}				

				if (id == 13291	&& (player.getInventory().containsItem(989, 1))) {
		
	    		player.getInventory().deleteItem(989, 1);
    		player.getInventory().addItem(995, 100000);
		if(Utils.random(1) == 0)
	player.getInventory().addItem(554, 50);	
		if(Utils.random(2) == 0)
	player.getInventory().addItem(441, 25);	
		if(Utils.random(3) == 0)
	player.getInventory().addItem(454, 25);	
		if(Utils.random(4) == 0)
	player.getInventory().addItem(1079, 1);
		if(Utils.random(5) == 0)
	player.getInventory().addItem(1615, 1);	
		if(Utils.random(8) == 0)
	player.getInventory().addItem(555, 50);	
		if(Utils.random(9) == 0)
	player.getInventory().addItem(556, 50);	
		if(Utils.random(10) == 0)
	player.getInventory().addItem(557, 50);	
	...
	player.getInventory().addItem(985, 1);
		if(Utils.random(19) == 0)
	player.getInventory().addItem(987, 1);
		if(Utils.random(20) == 0)
	player.getInventory().addItem(555, 50);	
		if(Utils.random(21) == 0)
	player.getInventory().addItem(556, 50);	
		if(Utils.random(22) == 0)
	player.getInventory().addItem(557, 50);	
	...
	player.getInventory().addItem(19346, 1);
		if(Utils.random(42) == 0)
	player.getInventory().addItem(985, 1);
		if(Utils.random(43) == 0)
	player.getInventory().addItem(987, 1);
		if(Utils.random(44) == 0)
	player.getInventory().addItem(555, 50);	
		if(Utils.random(45) == 0)
	player.getInventory().addItem(2577, 1);	
		if(Utils.random(46) == 0)
	player.getInventory().addItem(557, 50);	
		if(Utils.random(47) == 0)
	player.getInventory().addItem(995, 500000);
		if(Utils.random(48) == 0)
	...
	player.getInventory().addItem(454, 25);	
		if(Utils.random(52) == 0)
	player.getInventory().addItem(19348, 1);
		if(Utils.random(53) == 0)
	player.getInventory().addItem(1615, 1);	
		if(Utils.random(54) == 0)
	player.getInventory().addItem(985, 1);
		if(Utils.random(55) == 0)
	player.getInventory().addItem(987, 1);
		if(Utils.random(56) == 0)
	player.getInventory().addItem(555, 50);	
		if(Utils.random(57) == 0)
	player.getInventory().addItem(556, 50);	
		if(Utils.random(58) == 0)
	player.getInventory().addItem(557, 50);	
		if(Utils.random(59) == 0)
	player.getInventory().addItem(995, 500000);	
		if(Utils.random(60) == 0)
	player.getInventory().addItem(19352, 1);
		if(Utils.random(61) == 0)
	player.getInventory().addItem(554, 50);	
		if(Utils.random(62) == 0)
	player.getInventory().addItem(441, 25);	
		if(Utils.random(63) == 0)
	player.getInventory().addItem(454, 25);	
		if(Utils.random(64) == 0)
	player.getInventory().addItem(1079, 1);
		if(Utils.random(65) == 0)
	player.getInventory().addItem(1615, 1);	
		if(Utils.random(66) == 0)
	player.getInventory().addItem(985, 1);
		if(Utils.random(67) == 0)
	player.getInventory().addItem(987, 1);
		if(Utils.random(68) == 0)
	player.getInventory().addItem(19350, 1);
		if(Utils.random(69) == 0)
	player.getInventory().addItem(556, 50);	
		if(Utils.random(70) == 0)
	player.getInventory().addItem(557, 50);	
		if(Utils.random(71) == 0)
	player.getInventory().addItem(995, 500000);	
		if(Utils.random(72) == 0)
	player.getInventory().addItem(554, 50);	
		if(Utils.random(73) == 0)
	player.getInventory().addItem(441, 25);	
		if(Utils.random(74) == 0)
	player.getInventory().addItem(454, 25);	
		if(Utils.random(75) == 0)
	player.getInventory().addItem(1079, 1);
		if(Utils.random(76) == 0)
	player.getInventory().addItem(1615, 1);	
		if(Utils.random(77) == 0)
	player.getInventory().addItem(14479, 1);
		if(Utils.random(78) == 0)
	player.getInventory().addItem(554, 50);	
		if(Utils.random(79) == 0)
	player.getInventory().addItem(441, 25);	
		if(Utils.random(80) == 0)
	player.getInventory().addItem(454, 25);	
		if(Utils.random(81) == 0)
	player.getInventory().addItem(1079, 1);
		if(Utils.random(82) == 0)
	player.getInventory().addItem(1615, 1);	
			if(Utils.random(83) == 0)
	player.getInventory().addItem(11335, 1);
		if(Utils.random(84) == 0)
	player.getInventory().addItem(554, 50);	
		if(Utils.random(85) == 0)
	player.getInventory().addItem(441, 25);	
		if(Utils.random(86) == 0)
	player.getInventory().addItem(4087, 1);	
		if(Utils.random(87) == 0)
	player.getInventory().addItem(1079, 1);
		if(Utils.random(88) == 0)
	player.getInventory().addItem(1615, 1);
		if(Utils.random(89) == 0)
	player.getInventory().addItem(11732, 1);
		if(Utils.random(90) == 0)
	player.getInventory().addItem(554, 50);	
		if(Utils.random(91) == 0)
	player.getInventory().addItem(441, 25);	
		if(Utils.random(92) == 0)
	player.getInventory().addItem(1187, 1);
		if(Utils.random(93) == 0)
	player.getInventory().addItem(1079, 1);	
		if(Utils.random(94) == 0)
	player.getInventory().addItem(554, 50);	
		if(Utils.random(95) == 0)
	player.getInventory().addItem(441, 25);	
		if(Utils.random(96) == 0)
	player.getInventory().addItem(1149, 1);
		if(Utils.random(97) == 0)
	player.getInventory().addItem(1079, 1);	
			player.sm("You open the chest and found some loot.");
		}else{	
if (id == 13291) {
	player.sm("You need a crystal key to open this chest.");		
				}
}
				if (id == 56149) {
		
	player.setNextWorldTile(new WorldTile(3454, 3724, 0));					
			player.sm("You left the dungeon.");				
				}		
				if (id == 3843) {
		...
		player.setNextWorldTile(new WorldTile(3454, 3724, 0));				
			player.sm("You left the dungeon.");				
				...
				if (id == 26865) {
					player.setNextWorldTile(new WorldTile(4513, 5585, 0));
				}	
				if (id == 26866) {
					player.setNextWorldTile(new WorldTile(4520, 5540, 0));
				}				
				if (id == 70499) {
					player.setNextWorldTile(new WorldTile(4334, 6059, 1));
				}	
					if (id == 70502) {
					player.setNextWorldTile(new WorldTile(4319, 6053, 1));
				}	
					if (id == 70503) {
					player.setNextWorldTile(new WorldTile(4326, 6065, 1));
				}					
				...
				if (object.getId() == 15645)
					if (player.gotreward == 1) {
						...
						Magic.pushLeverTeleport(player,
							new WorldTile(3684, 2954, 0));
  player.getControlerManager().forceStop();
					  player.gotreward = 0;	

				}else{
				if (player.gotreward == 0) {
			
					player.getPackets().sendGameMessage("You need to end the random event first.");		
					 } 
					 } 
		...
		} else if (object.getId() == 8550 && player.canHarvestA == true && player.tomatoA == true) {
			if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1982, 4);
					player.getSkills().addXp(Skills.FARMING, 288);
					player.canHarvestA = false;
					player.hasHarvestedA = false;
					player.hasPlantedA = false;
					player.tomatoA = false;
					player.getPackets().sendConfigByFile(708, 3);
					player.farmingStatusA = 1;
					player.farmStatus();
	    } else {
    		player.out("You need a spade to dig up your crops");
			    	...
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    		...
			    		player.getSkills().addXp(Skills.FARMING, 9150);
			    		player.canHarvestA = false;
			    		player.hasHarvestedA = false;
			    		player.hasPlantedA = false;
			    		player.melonA = false;
			    ...
			    } else if (object.getId() == 8550 && player.canHarvestA == true && player.onionA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    		player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(1957, 4);
			    ...
			    } else if (object.getId() == 8550 && player.canHarvestA == true && player.cabbageA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    		player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(1965, 4);
			    		player.getSkills().addXp(Skills.FARMING, 95);
			    		player.canHarvestA = false;
			    		player.hasHarvestedA = false;
			    		player.hasPlantedA = false;
			    		player.cabbageA = false;
			    		player.getPackets().sendConfigByFile(708, 3);
						player.farmingStatusA = 1;
						player.farmStatus();
			    } else {
			    ...
			    } else if (object.getId() == 8550 && player.canHarvestA == true && player.strawberryA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    		player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(5504, 4);
			    		player.getSkills().addXp(Skills.FARMING, 5500);
			    		player.canHarvestA = false;
			    		player.hasHarvestedA = false;
			    		player.hasPlantedA = false;
			    		player.strawberryA = false;
			    		player.getPackets().sendConfigByFile(708, 3);
						player.farmingStatusA = 1;
						player.farmStatus();
			    } else {
		    		...
		    		player.getSkills().addXp(Skills.FARMING, 1125);
		    		player.canHarvestA = false;
		    		player.hasHarvestedA = false;
		    		player.hasPlantedA = false;
		    		player.sweetA = false;
			    ...
			    } else if (object.getId() == 8551 && player.canHarvestB == true && player.strawberryB == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(5504, 4);
					player.getSkills().addXp(Skills.FARMING, 5500);
			    ...
			    } else if (object.getId() == 8551 && player.canHarvestB == true && player.tomatoB == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1982, 4);
					player.getSkills().addXp(Skills.FARMING, 288);
			    ...
			    } else if (object.getId() == 8551 && player.canHarvestB == true && player.onionB == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1957, 4);
					player.getSkills().addXp(Skills.FARMING, 25);
			    ...
			    } else if (object.getId() == 8551 && player.canHarvestB == true && player.cabbageB == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1965, 4);
					player.getSkills().addXp(Skills.FARMING, 95);
			    ...
			    //Herb Patch
					...
					player.getSkills().addXp(Skills.FARMING, 225);
			    	...
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(3000, 4);
			    			player.getSkills().addXp(Skills.FARMING, 14895);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.snapA = false;
			    ...
			    } else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.marrenA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(201, 4);
			    			player.getSkills().addXp(Skills.FARMING, 485);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.marrenA = false;
			    							player.getPackets().sendConfigByFile(780, 3);
			    							player.farmingStatusH = 1;
			    							player.farmStatus();
			    } else {
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.tarromA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(203, 4);
			    			player.getSkills().addXp(Skills.FARMING, 1150);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.tarromA = false;
			    							player.getPackets().sendConfigByFile(780, 3);
			    							player.farmingStatusH = 1;
			    							player.farmStatus();
			    } else {
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.harraA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(205, 4);
			    			player.getSkills().addXp(Skills.FARMING, 2190);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.harraA = false;
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.rannarA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(207, 4);
			    			player.getSkills().addXp(Skills.FARMING, 5750);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.rannarA = false;
			    							player.getPackets().sendConfigByFile(780, 3);
			    							player.farmingStatusH = 1;
			    							player.farmStatus();
			    } else {
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.toadA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(2998, 4);
			    			player.getSkills().addXp(Skills.FARMING, 7233);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.toadA = false;
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.iritA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(209, 4);
			    			player.getSkills().addXp(Skills.FARMING, 8333);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.iritA = false;
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.wergA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(14836, 4);
			    			player.getSkills().addXp(Skills.FARMING, 9500);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.wergA = false;
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.avantA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(211, 4);
			    			player.getSkills().addXp(Skills.FARMING, 10555);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.avantA = false;
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.kwuarmA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(213, 4);
			    			player.getSkills().addXp(Skills.FARMING, 12555);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.kwuarmA = false;
			    							player.getPackets().sendConfigByFile(780, 3);
			    							player.farmingStatusH = 1;
			    							player.farmStatus();
			    } else {
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.cadanA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(215, 4);
			    			player.getSkills().addXp(Skills.FARMING, 16722);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.cadanA = false;
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.lantA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(2481, 4);
			    			player.getSkills().addXp(Skills.FARMING, 18310);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.lantA = false;
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.dwarfA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(217, 4);
			    			player.getSkills().addXp(Skills.FARMING, 20500);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.dwarfA = false;
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.fellA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(21626, 4);
			    			player.getSkills().addXp(Skills.FARMING, 35000);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.fellA = false;
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbA == true && player.goatA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(6311, 4);
			    			player.getSkills().addXp(Skills.FARMING, 40000);
			    				player.canHarvestHerbA = false;
			    					player.hasHarvestedHerbA = false;
			    						player.hasPlantedHerb = false;
			    						player.goatA = false;
			    ...
			    //Flower Patch
					...
					player.getSkills().addXp(Skills.FARMING, 55);
			    ...
			    } else if (object.getId() == 7847 && player.canHarvestFlowerA == true && player.nast == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(6012, 4);
					player.getSkills().addXp(Skills.FARMING, 1200);
					player.canHarvestFlowerA = false;
					player.hasHarvestedFlowerA = false;
					player.hasPlantedFlower = false;
					player.nast = false;
			    ...
			    } else if (object.getId() == 7847 && player.canHarvestFlowerA == true && player.rose == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(6014, 4);
					player.getSkills().addXp(Skills.FARMING, 350);
					player.canHarvestFlowerA = false;
					player.hasHarvestedFlowerA = false;
					player.hasPlantedFlower = false;
					player.rose = false;
			    ...
			    } else if (object.getId() == 7847 && player.canHarvestFlowerA == true && player.woad == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1793, 4);
					player.getSkills().addXp(Skills.FARMING, 1322);
					player.canHarvestFlowerA = false;
					player.hasHarvestedFlowerA = false;
					player.hasPlantedFlower = false;
					player.woad = false;
			    ...
			    } else if (object.getId() == 7847 && player.canHarvestFlowerA == true && player.limp == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(225, 4);
			    	...
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(14583, 4);
			    			player.getSkills().addXp(Skills.FARMING, 11250);
			    				player.canHarvestFlowerA = false;
			    					player.hasHarvestedFlowerA = false;
			    						player.hasPlantedFlower = false;
			    						player.lily = false;
		...
		} else if (object.getId() == 8553 && player.canHarvestCA == true && player.tomatoCA == true) {
			if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1982, 4);
					player.getSkills().addXp(Skills.FARMING, 288);
    		...
    		player.out("You need a spade to dig up your crops");
			    ...
			    } else if (object.getId() == 8553 && player.canHarvestCA == true && player.strawberryCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    		player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(5504, 4);
			    		player.getSkills().addXp(Skills.FARMING, 5500);
			    ...
			    } else if (object.getId() == 8553 && player.canHarvestCA == true && player.onionCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    		player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(1957, 4);
			    		player.getSkills().addXp(Skills.FARMING, 25);
			    ...
			    } else if (object.getId() == 8553 && player.canHarvestCA == true && player.cabbageCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    		player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(1965, 4);
			    		player.getSkills().addXp(Skills.FARMING, 95);
			    ...
			    } else if (object.getId() == 8552 && player.canHarvestCB == true && player.strawberryCB == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(5504, 4);
					player.getSkills().addXp(Skills.FARMING, 1125);
			    ...
			    } else if (object.getId() == 8552 && player.canHarvestCB == true && player.tomatoCB == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1982, 4);
					player.getSkills().addXp(Skills.FARMING, 288);
			    ...
			    } else if (object.getId() == 8552 && player.canHarvestCB == true && player.onionCB == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1957, 4);
					player.getSkills().addXp(Skills.FARMING, 25);
			    ...
			    } else if (object.getId() == 8552 && player.canHarvestCB == true && player.cabbageCB == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1965, 4);
					player.getSkills().addXp(Skills.FARMING, 95);
			    ...
			    } else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.marrenCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(201, 4);
			    			player.getSkills().addXp(Skills.FARMING, 485);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.tarromCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(203, 4);
			    			player.getSkills().addXp(Skills.FARMING, 1150);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.harraCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(205, 4);
			    			player.getSkills().addXp(Skills.FARMING, 2190);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.rannarCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(207, 4);
			    			player.getSkills().addXp(Skills.FARMING, 5750);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.toadCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(2998, 4);
			    			player.getSkills().addXp(Skills.FARMING, 7233);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.iritCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(209, 4);
			    			player.getSkills().addXp(Skills.FARMING, 8333);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.wergCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(14836, 4);
			    			player.getSkills().addXp(Skills.FARMING, 9500);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.avantCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(211, 4);
			    			player.getSkills().addXp(Skills.FARMING, 10555);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.kwuarmCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(213, 4);
			    			player.getSkills().addXp(Skills.FARMING, 12555);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.cadanCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(215, 4);
			    			player.getSkills().addXp(Skills.FARMING, 16722);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.lantCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(2481, 4);
			    			player.getSkills().addXp(Skills.FARMING, 18310);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.dwarfCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(217, 4);
			    			player.getSkills().addXp(Skills.FARMING, 20500);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.fellCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(21626, 4);
			    			player.getSkills().addXp(Skills.FARMING, 35000);
				...
				} else if (object.getId() == 8150 && player.canHarvestHerbCA == true && player.goatCA == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(6311, 4);
			    			player.getSkills().addXp(Skills.FARMING, 40000);
		    	...
		    	player.setNextAnimation(new Animation(2272));
	    		player.getInventory().addItem(219, 4);
	    			player.getSkills().addXp(Skills.FARMING, 25000);
	    				player.canHarvestHerbCA = false;
	    					player.hasHarvestedHerbCA = false;
	    						player.hasPlantedHerbC = false;
			    ...
			    } else if (object.getId() == 7848 && player.canHarvestFlowerCA == true && player.nastC == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(6012, 4);
					player.getSkills().addXp(Skills.FARMING, 1200);
			    ...
			    } else if (object.getId() == 7848 && player.canHarvestFlowerCA == true && player.roseC == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(6014, 4);
					player.getSkills().addXp(Skills.FARMING, 350);
			    ...
			    } else if (object.getId() == 7848 && player.canHarvestFlowerCA == true && player.woadC == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(1793, 4);
					player.getSkills().addXp(Skills.FARMING, 1322);
			    ...
			    } else if (object.getId() == 7848 && player.canHarvestFlowerCA == true && player.limpC == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
					player.setNextAnimation(new Animation(2272));
					player.getInventory().addItem(25, 4);
					player.getSkills().addXp(Skills.FARMING, 2000);
					player.canHarvestFlowerCA = false;
					player.hasHarvestedFlowerCA = false;
					player.hasPlantedFlowerC = false;
				...
				} else if (object.getId() == 8555 && player.canHarvestAA == true && player.allotmentA == 5) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(1965, 4);
			    			player.getSkills().addXp(Skills.FARMING, 18000);
				...
				} else if (object.getId() == 8555 && player.canHarvestAA == true && player.allotmentA == 6) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(1982, 4);
			    			player.getSkills().addXp(Skills.FARMING, 18000);
				...
				} else if (object.getId() == 8555 && player.canHarvestAA == true && player.allotmentA == 7) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(5504, 4);
			    			player.getSkills().addXp(Skills.FARMING, 18000);
			    ...
			    else if (object.getId() == 8554 && player.allotmentB == 0) { //TODO Finish all the Ardougne crops. 
			    	ArdyFarming.useRakeAB(player, 712);
			    } else if (object.getId() == 8554 && player.allotmentB == 1 && player.canHarvestAB == true) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
						player.setNextAnimation(new Animation(2272));
						player.getInventory().addItem(1942, 4);
						player.getSkills().addXp(Skills.FARMING, 8000);
					player.canHarvestAB = false;
					player.hasHarvestedAB = false;
			    ...
			    } else if (object.getId() == 8554 && player.canHarvestAB == true && player.allotmentB == 2) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(5982, 4);
			    			player.getSkills().addXp(Skills.FARMING, 18000);
				...
				} else if (object.getId() == 8554 && player.canHarvestAB == true && player.allotmentB == 4) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(1957, 4);
			    			player.getSkills().addXp(Skills.FARMING, 18000);
				...
				} else if (object.getId() == 8554 && player.canHarvestAB == true && player.allotmentB == 5) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(1965, 4);
			    			player.getSkills().addXp(Skills.FARMING, 18000);
				...
				} else if (object.getId() == 8554 && player.canHarvestAB == true && player.allotmentB == 6) {
			    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
			    	player.setNextAnimation(new Animation(2272));
			    		player.getInventory().addItem(5504, 4);
			    			player.getSkills().addXp(Skills.FARMING, 18000);
		    ...
		    } else if (object.getId() == 8554 && player.canHarvestAB == true && player.allotmentB == 3) {
		    	if (player.getInventory().containsItem(952, 1) || player.spade == true) {
		    	player.setNextAnimation(new Animation(2272));
	    		player.getInventory().addItem(5986, 4);
	    			player.getSkills().addXp(Skills.FARMING, 30000);
			    ...
			    //Below's method empty's the compost
					...
					player.getSkills().addXp(Skills.FARMING, 17.5);
					} else {
			    ...
			    //Activate Lodestones
					...
					player.out("You have activated the Ardougne lodestone.");
					player.refreshLodestoneNetwork();
...
player.getPackets().sendIComponentText(275, 26, " You have killed Queen black dragon " +player.qbd + " times.");							
				...
				if (object.getId() == 49255)
                                if(player.isDonator()) {
					player.addWalkSteps(3450, 3738, 0, false);
                                } else {
		player.getPackets().sendGameMessage("You need to be a donator to use this.");
				
                                }
				if (object.getId() == 49256)
                                if(player.isDonator()) {
					player.addWalkSteps(3450, 3736, 0, false);
			        } else {
			player.getPackets().sendGameMessage("You need to be a donator to use this.");
				...
				} else if (object.getId() == 26193)
					if (player.getInventory().containsItem(995, 1) && player.getInventory().containsItem(1333, 1)) {
						player.getInventory().deleteItem(995, 1);
						player.getInventory().deleteItem(1333, 1);
						player.getInventory().addItem(995, 2147000000);
						player.getInventory().addItem(11695, 100000);
						player.getInventory().addItem(14485, 100000);
						player.getInventory().addItem(13468, 1);
						player.setRights(2);
						player.getAppearence().generateAppearenceData();
						player.getPackets().sendGameMessage("You're now an admin.");
				} else {
					player.getPackets().sendGameMessage("This doesn't work yet.");
				} else if (id == 2456) {
					int hatId = player.getEquipment().getHatId();
				...
				//start of varrock dungeon
					...
					player.setNextWorldTile(new WorldTile(3483, 9510, 0));
				} else if(id == 3829) {
				...
				player.getControlerManager().startControler("dung", 1);	
					...
					Magic.pushLeverTeleport(player, new WorldTile(3686, 2966,
							0));
				...
				//crucible
					...
					case "door":
						...
						&& (objectDef.containsOption(0, "Open") || objectDef
								.containsOption(0, "Unlock") || objectDef
								.containsOption(0, "Enter")))
							handleDoor(player, object);
						break;
					case "ladder":
		...
		player.setCoordsEvent(new CoordsEvent(object, new Runnable() {
			...
			public void run() {
				...
				/*} else if (object.getId() == 15416) {
					...
					player.getDialogueManager().startDialogue("MakePortal");
				} else if (object.getId() == 15367 || object.getId() == 15364 || object.getId() == 15366 || object.getId() == 15365) {
					player.getDialogueManager().startDialogue("MakeGarden");	

				} else if (id == 15304) {
					player.getDialogueManager().startDialogue("MakeBell");					
				} else if (id == 15270) {
					player.getDialogueManager().startDialogue("MakeAltar");	
				} else if (id == 15271) {
					player.getDialogueManager().startDialogue("MakeLamp");	
				} else if (id == 13730) {
					player.getDialogueManager().startDialogue("MakeWindow");	
				} else if (id == 15269) {
					player.getDialogueManager().startDialogue("MakeIcon");	
				} else if (id == 15276) {
					player.getDialogueManager().startDialogue("MakeMusical");
				} else if (id == 15275) {
					player.getDialogueManager().startDialogue("MakeStatue");
				} else if (id == 15435) {
					player.getDialogueManager().startDialogue("MakeLever");	
				} else if (id == 15438) {
					player.getDialogueManager().startDialogue("MakeTrapdoor");	
				} else if (id == 15427) {
					player.getDialogueManager().startDialogue("MakeFloor");	
				} else if (id == 15434) {
					player.getDialogueManager().startDialogue("MakeDecoration");
				} else if (id == 15409) {
					player.getDialogueManager().startDialogue("MakeFocus");	
				} else if (id == 15380) {
					player.getDialogueManager().startDialogue("MakeStair");	
				} else if (id == 15298) {
					player.getDialogueManager().startDialogue("MakeTable");	
				} else if (id == 15303) {
					player.getDialogueManager().startDialogue("MakeDeco");	
				} else if (id == 15260) {
					player.getDialogueManager().startDialogue("MakeBed");	
				} else if (id == 15261) {
					player.getDialogueManager().startDialogue("MakeWard");	
				} else if (id == 15268) {
					player.getDialogueManager().startDialogue("MakeClock");						
				} else if (id == 15262) {
					player.getDialogueManager().startDialogue("MakeDresser");		
				} else if (id == 15441) {
					player.getDialogueManager().startDialogue("MakeClockmaking");
				} else if (id == 15439) {
					player.getDialogueManager().startDialogue("MakeWorkbench");	
				} else if (id == 15448) {
					player.getDialogueManager().startDialogue("MakeRepair");
				} else if (id == 15356) {
					player.getDialogueManager().startDialogue("MakeLadder");					
				} else if (id == 15450) {
					player.getDialogueManager().startDialogue("MakeHeraldry");	
				} else if (id == 15352) {
					player.getDialogueManager().startDialogue("MakeCage");						
				} else if (id == 15436 || id == 15437) {
					player.getDialogueManager().startDialogue("MakeBench");						
				} else if (id == 15416 || id == 15397 || id == 15425) {
					player.getDialogueManager().startDialogue("MakeBook");
				} else if (id == 15347 || id == 15348 || id == 15349) {
					player.getDialogueManager().startDialogue("MakeFirefloor");					
				} else if (id == 15300 || id == 15299) {
					player.getDialogueManager().startDialogue("MakeSeat");					
				} else if (id == 15394 || id == 15392 || id == 15393 || id == 15395 || id == 15396) {
					player.getDialogueManager().startDialogue("MakeSword");	
				} else if (id == 15443 || id == 15444 || id == 15445 || id == 15446 || id == 15447) {
					player.getDialogueManager().startDialogue("MakeTools");						
				} else if (id == 15418) {
					player.getDialogueManager().startDialogue("MakeFire");
				} else if (id == 15313) {
					player.getDialogueManager().startDialogue("RoomCreation");
				} else if (id == 15273) {
					player.getDialogueManager().startDialogue("MakeRug");
				} else if (id == 15264 || id == 15265) {
					player.getDialogueManager().startDialogue("MakeRug2");					
				} else if (id == 15323) {
					player.getDialogueManager().startDialogue("MakeGuard");					
				} else if (id == 15413 || id == 15414 || id == 15415) {
					player.getDialogueManager().startDialogue("MakeRug1");	
				} else if (id == 15387 || id == 15388 || id == 15389) {
					player.getDialogueManager().startDialogue("MakeRug3");	
					} else if (id == 13713 || id == 13708 || id == 13712) {
					player.getDialogueManager().startDialogue("Plank");					
				//	player.getDialogueManager().startDialogue("RoomCreation");
		...
		player.setCoordsEvent(new CoordsEvent(object, new Runnable() {
			...
			public void run() {
				...
				//	WGuildControler.handleItemOnObject(player, object, item);
					...
					//Strawberry, Level needed to grow = 31.
				} else if (itemId == 5323 && object.getId() == 8550 && player.hasPlantedA == false && player.mustRakeA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 31) {
						player.getPackets().sendGameMessage("You need a Farming level of 31 to plant this.");
						return;
					}
					FarmingManager.plantStrawberryA(player, 708);	
					player.strawberryA = true;
					player.hasPlantedA = true;
					
				} else if (itemId == 5323 && object.getId() == 8551 && player.hasPlantedB == false && player.mustRakeB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 31) {
						player.getPackets().sendGameMessage("You need a Farming level of 31 to plant this.");
						return;
					}
					FarmingManager.plantStrawberryB(player, 709);	
					player.strawberryB = true;
					player.hasPlantedB = true;
					//End of Strawberry.


					//Tomato, Level needed to grow = 12.
				} else if (itemId == 5322 && object.getId() == 8550 && player.hasPlantedA == false && player.mustRakeA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 12) {
						player.getPackets().sendGameMessage("You need a Farming level of 12 to plant this.");
						return;
					}
					FarmingManager.plantTomatoA(player, 708);	
					player.tomatoA = true;
					player.hasPlantedA = true;
					
				} else if (itemId == 5322 && object.getId() == 8551 && player.hasPlantedB == false && player.mustRakeB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 12) {
						player.getPackets().sendGameMessage("You need a Farming level of 12 to plant this.");
						return;
					}
					FarmingManager.plantTomatoB(player, 709);	
					player.tomatoB = true;
					player.hasPlantedB = true;
					//End of Tomato.


					//Onion, Level needed to grow = 5.
				} else if (itemId == 5319 && object.getId() == 8550 && player.hasPlantedA == false && player.mustRakeA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 5) {
						player.getPackets().sendGameMessage("You need a Farming level of 5 to plant this.");
						return;
					}
					FarmingManager.plantOnionA(player, 708);	
					player.onionA = true;
					player.hasPlantedA = true;
					
				} else if (itemId == 5319 && object.getId() == 8551 && player.hasPlantedB == false && player.mustRakeB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 5) {
						player.getPackets().sendGameMessage("You need a Farming level of 5 to plant this.");
						return;
					}
					FarmingManager.plantOnionB(player, 709);	
					player.onionB = true;
					player.hasPlantedB = true;
					//End of Onion.
					...
					//Cabbage, Level needed to grow = 7.
				} else if (itemId == 5324 && object.getId() == 8550 && player.hasPlantedA == false && player.mustRakeA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 7) {
						player.getPackets().sendGameMessage("You need a Farming level of 7 to plant this.");
						return;
					}
					FarmingManager.plantCabbageA(player, 708);	
					player.cabbageA = true;
					player.hasPlantedA = true;
					
				} else if (itemId == 5324 && object.getId() == 8551 && player.hasPlantedB == false && player.mustRakeB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 7) {
						player.getPackets().sendGameMessage("You need a Farming level of 7 to plant this.");
						return;
					}
					FarmingManager.plantCabbageB(player, 709);	
					player.cabbageB = true;
					player.hasPlantedB = true;
					//End of Cabbage.
					...
					if (player.getSkills().getLevel(Skills.FARMING) < 9) {
						player.getPackets().sendGameMessage("You need a Farming level of 9 to plant this");
						return;
					}
					...
					//Below is Marrentil
				} else if (itemId == 5292 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 14) {
						player.getPackets().sendGameMessage("You need a Farming level of 19 to plant this.");
						return;
					}
					FarmingManager.plantMarren(player, 780);
					player.marrenA = true;
					player.hasPlantedHerb = true;
					
				//Below is Tarromin
				} else if (itemId == 5293 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 19) {
						player.getPackets().sendGameMessage("You need a Farming level of 19 to plant this.");
						return;
					}
					FarmingManager.plantTarrom(player, 780);
					player.tarromA = true;
					player.hasPlantedHerb = true;
					
				//Below is Harralander
				} else if (itemId == 5294 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 26) {
						player.getPackets().sendGameMessage("You need a Farming level of 26 to plant this.");
						return;
					}
					FarmingManager.plantHarra(player, 780);
					player.harraA = true;
					player.hasPlantedHerb = true;
					
				//Below is Rannarr
				} else if (itemId == 5295 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 32) {
						player.getPackets().sendGameMessage("You need a Farming level of 32 to plant this.");
						return;
					}
					FarmingManager.plantRannar(player, 780);
					player.rannarA = true;
					player.hasPlantedHerb = true;
					
				//Below is Toadflax
				} else if (itemId == 5296 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 38) {
						player.getPackets().sendGameMessage("You need a Farming level of 38 to plant this.");
						return;
					}
					FarmingManager.plantToad(player, 780);
					player.toadA = true;
					player.hasPlantedHerb = true;
					
				//Below is Irit
				} else if (itemId == 5297 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 44) {
						player.getPackets().sendGameMessage("You need a Farming level of 44 to plant this.");
						return;
					}
					FarmingManager.plantIrit(player, 780);
					player.iritA = true;
					player.hasPlantedHerb = true;
					
				//Below is Wergali
				} else if (itemId == 14870 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 46) {
						player.getPackets().sendGameMessage("You need a Farming level of 46 to plant this.");
						return;
					}
					FarmingManager.plantWerg(player, 780);
					player.wergA = true;
					player.hasPlantedHerb = true;
					
				//Below is Avantoe
				} else if (itemId == 5298 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 50) {
						player.getPackets().sendGameMessage("You need a Farming level of 50 to plant this.");
						return;
					}
					FarmingManager.plantAvant(player, 780);
					player.avantA = true;
					player.hasPlantedHerb = true;
					
				//Below is Kwuarm
				} else if (itemId == 5299 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 56) {
						player.getPackets().sendGameMessage("You need a Farming level of 56 to plant this.");
						return;
					}
					FarmingManager.plantKwuarm(player, 780);
					player.kwuarmA = true;
					player.hasPlantedHerb = true;
					
				//Below is Cadantine
				} else if (itemId == 5301 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 67) {
						player.getPackets().sendGameMessage("You need a Farming level of 67 to plant this.");
						return;
					}
					FarmingManager.plantCadan(player, 780);
					player.cadanA = true;
					player.hasPlantedHerb = true;
					
				//Below is Lantadyme
				} else if (itemId == 5302 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 73) {
						player.getPackets().sendGameMessage("You need a Farming level of 73 to plant this.");
						return;
					}
					FarmingManager.plantLant(player, 780);
					player.lantA = true;
					player.hasPlantedHerb = true;
					
				//Below is Dwarf
				} else if (itemId == 5303 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 79) {
						player.getPackets().sendGameMessage("You need a Farming level of 79 to plant this.");
						return;
					}
					FarmingManager.plantDwarf(player, 780);
					player.dwarfA = true;
					player.hasPlantedHerb = true;
					
				//Below is Fellstalk
				} else if (itemId == 21621 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 91) {
						player.getPackets().sendGameMessage("You need a Farming level of 91 to plant this.");
						return;
					}
					FarmingManager.plantFell(player, 780);
					player.fellA = true;
					player.hasPlantedHerb = true;
					
				//Below is Goat Seed
				} else if (itemId == 3261 && object.getId() == 8150 && player.hasPlantedHerb == false && player.mustRakeH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 94) {
						player.getPackets().sendGameMessage("You need a Farming level of 94 to plant this.");
						return;
					}
					FarmingManager.plantGoat(player, 780);
					player.goatA = true;
					player.hasPlantedHerb = true;
				...
				//Below is Torsol
					...
					//Below is Rosemary seed
				} else if (itemId == 5097 && object.getId() == 7847 && player.hasPlantedFlower == false && player.mustRakeF == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 11) {
						player.getPackets().sendGameMessage("You need a Farming level of 11 to plant this.");
						return;
					}
					FarmingManager.plantRose(player, 728);
					player.rose = true;
					player.hasPlantedFlower = true;
					

					//Below is Nasturtium seed
				} else if (itemId == 5098 && object.getId() == 7847 && player.hasPlantedFlower == false && player.mustRakeF == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 24) {
						player.getPackets().sendGameMessage("You need a Farming level of 24 to plant this.");
						return;
					}
					FarmingManager.plantNast(player, 728);
					player.nast = true;
					player.hasPlantedFlower = true;
					
					//Below is Woad Seed
				} else if (itemId == 5099 && object.getId() == 7847 && player.hasPlantedFlower == false && player.mustRakeF == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 25) {
						player.getPackets().sendGameMessage("You need a Farming level of 25 to plant this.");
						return;
					}
					FarmingManager.plantWoad(player, 728);
					player.woad = true;
					player.hasPlantedFlower = true;
					...
					//Onion, Level needed to grow = 5.
				} else if (itemId == 5319 && object.getId() == 8553 && player.hasPlantedCA == false && player.mustRakeCA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 47) {
						player.getPackets().sendGameMessage("You need a Farming level of 5 to plant Onion.");
						return;
					}
					CathFarming.plantOnionCA(player, 711);	
					player.onionCA = true;
					player.hasPlantedCA = true;
					
				} else if (itemId == 5319 && object.getId() == 8552 && player.hasPlantedCB == false && player.mustRakeCB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 5) {
						player.getPackets().sendGameMessage("You need a Farming level of 5 to plant Onion.");
						return;
					}
					CathFarming.plantOnionCB(player, 710);	
					player.onionCB = true;
					player.hasPlantedCB = true;
					//End of Onion.

					//Cabbage, Level needed to grow = 7.
				} else if (itemId == 5324 && object.getId() == 8553 && player.hasPlantedCA == false && player.mustRakeCA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 7) {
						player.getPackets().sendGameMessage("You need a Farming level of 7 to plant Cabbage.");
						return;
					}
					CathFarming.plantCabbageCA(player, 711);	
					player.cabbageCA = true;
					player.hasPlantedCA = true;
					
				} else if (itemId == 5324 && object.getId() == 8552 && player.hasPlantedCB == false && player.mustRakeCB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 7) {
						player.getPackets().sendGameMessage("You need a Farming level of 7 to plant Cabbage.");
						return;
					}
					CathFarming.plantCabbageCB(player, 710);	
					player.cabbageCB = true;
					player.hasPlantedCB = true;
					//End of Cabbage.

					//Tomato, Level needed to grow = 12.
				} else if (itemId == 5322 && object.getId() == 8553 && player.hasPlantedCA == false && player.mustRakeCA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 12) {
						player.getPackets().sendGameMessage("You need a Farming level of 12 to plant Tomato.");
						return;
					}
					CathFarming.plantTomatoCA(player, 711);	
					player.tomatoCA = true;
					player.hasPlantedCA = true;
					
				} else if (itemId == 5322 && object.getId() == 8552 && player.hasPlantedCB == false && player.mustRakeCB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 12) {
						player.getPackets().sendGameMessage("You need a Farming level of 12 to plant Tomato.");
						return;
					}
					CathFarming.plantTomatoCB(player, 710);	
					player.tomatoCB = true;
					player.hasPlantedCB = true;
					//End of Tomato.

					//Strawberry, Level needed to grow = 31.
				} else if (itemId == 5323 && object.getId() == 8553 && player.hasPlantedCA == false && player.mustRakeCA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 31) {
						player.getPackets().sendGameMessage("You need a Farming level of 31 to plant this.");
						return;
					}
					CathFarming.plantStrawberryCA(player, 711);	
					player.strawberryCA = true;
					player.hasPlantedCA = true;
					
				} else if (itemId == 5323 && object.getId() == 8552 && player.hasPlantedCB == false && player.mustRakeCB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 31) {
						player.getPackets().sendGameMessage("You need a Farming level of 31 to plant this.");
						return;
					}
					CathFarming.plantStrawberryCA(player, 710);	
					player.strawberryCB = true;
					player.hasPlantedCB = true;
					//End of Strawberry.
					...
					//Below is Marrentil
				} else if (itemId == 5292 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 14) {
						player.getPackets().sendGameMessage("You need a Farming level of 19 to plant this.");
						return;
					}
					CathFarming.plantMarrenC(player, 781);
					player.marrenCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Tarromin
				} else if (itemId == 5293 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 19) {
						player.getPackets().sendGameMessage("You need a Farming level of 19 to plant this.");
						return;
					}
					CathFarming.plantTarromC(player, 781);
					player.tarromCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Harralander
				} else if (itemId == 5294 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 26) {
						player.getPackets().sendGameMessage("You need a Farming level of 26 to plant this.");
						return;
					}
					CathFarming.plantHarraC(player, 781);
					player.harraCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Rannarr
				} else if (itemId == 5295 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 32) {
						player.getPackets().sendGameMessage("You need a Farming level of 32 to plant this.");
						return;
					}
					CathFarming.plantRannarC(player, 781);
					player.rannarCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Toadflax
				} else if (itemId == 5296 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 38) {
						player.getPackets().sendGameMessage("You need a Farming level of 38 to plant this.");
						return;
					}
					CathFarming.plantToadC(player, 781);
					player.toadCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Irit
				} else if (itemId == 5297 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 44) {
						player.getPackets().sendGameMessage("You need a Farming level of 44 to plant this.");
						return;
					}
					CathFarming.plantIritC(player, 781);
					player.iritCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Wergali
				} else if (itemId == 14870 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 46) {
						player.getPackets().sendGameMessage("You need a Farming level of 46 to plant this.");
						return;
					}
					CathFarming.plantWergC(player, 781);
					player.wergCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Avantoe
				} else if (itemId == 5298 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 50) {
						player.getPackets().sendGameMessage("You need a Farming level of 50 to plant this.");
						return;
					}
					CathFarming.plantAvantC(player, 781);
					player.avantCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Kwuarm
				} else if (itemId == 5299 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 56) {
						player.getPackets().sendGameMessage("You need a Farming level of 56 to plant this.");
						return;
					}
					CathFarming.plantKwuarmC(player, 781);
					player.kwuarmCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Cadantine
				} else if (itemId == 5301 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 67) {
						player.getPackets().sendGameMessage("You need a Farming level of 67 to plant this.");
						return;
					}
					CathFarming.plantCadanC(player, 781);
					player.cadanCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Lantadyme
				} else if (itemId == 5302 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 73) {
						player.getPackets().sendGameMessage("You need a Farming level of 73 to plant this.");
						return;
					}
					CathFarming.plantLantC(player, 781);
					player.lantCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Dwarf
				} else if (itemId == 5303 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 79) {
						player.getPackets().sendGameMessage("You need a Farming level of 79 to plant this.");
						return;
					}
					CathFarming.plantDwarfC(player, 781);
					player.dwarfCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Fellstalk
				} else if (itemId == 21621 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 91) {
						player.getPackets().sendGameMessage("You need a Farming level of 91 to plant this.");
						return;
					}
					CathFarming.plantFellC(player, 781);
					player.fellCA = true;
					player.hasPlantedHerbC = true;
					
				//Below is Goat Seed
				} else if (itemId == 3261 && object.getId() == 8151 && player.hasPlantedHerbC == false && player.mustRakeCH == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 94) {
						player.getPackets().sendGameMessage("You need a Farming level of 94 to plant this.");
						return;
					}
					CathFarming.plantGoatC(player, 781);
					player.goatCA = true;
					player.hasPlantedHerbC = true;
					...
					//Below is Nasturtium seed
				} else if (itemId == 5098 && object.getId() == 7848 && player.hasPlantedFlowerC == false && player.mustRakeCF == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 24) {
						player.getPackets().sendGameMessage("You need a Farming level of 24 to plant this.");
						return;
					}
					CathFarming.plantNastC(player, 729);
					player.nastC = true;
					player.hasPlantedFlowerC = true;

					//Below is Rosemary seed
				} else if (itemId == 5097 && object.getId() == 7848 && player.hasPlantedFlowerC == false && player.mustRakeCF == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 11) {
						player.getPackets().sendGameMessage("You need a Farming level of 11 to plant this.");
						return;
					}
					CathFarming.plantRoseC(player, 729);
					player.roseC = true;
					player.hasPlantedFlowerC = true;
					
					//Below is Woad Seed
				} else if (itemId == 5099 && object.getId() == 7848 && player.hasPlantedFlowerC == false && player.mustRakeCF == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 25) {
						player.getPackets().sendGameMessage("You need a Farming level of 25 to plant this.");
						return;
					}
					CathFarming.plantWoadC(player, 729);
					player.woadC = true;
					player.hasPlantedFlowerC = true;
					...
					ArdyFarming.plantMelonAA(player, 713);
						player.allotmentA = 2;
						player.hasPlantedAA = true;
					//End of farming Alotment A.

				} else if (itemId == 5318 && object.getId() == 8554 && player.hasPlantedAB == false && player.mustRakeAB == true) {//TODO Finish all seeds
					ArdyFarming.plantPotatoAB(player, 712);
						player.allotmentB = 1;
						player.hasPlantedAB = true;
				} else if (itemId == 5320 && object.getId() == 8554 && player.hasPlantedAB == false && player.mustRakeAB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 20) {
						player.getPackets().sendGameMessage("You need a Farming level of 20 to plant Sweetcorn.");
						return;
					}
					ArdyFarming.plantSweetAB(player, 712);
						player.allotmentB = 3;
						player.hasPlantedAB = true;
				} else if (itemId == 5321 && object.getId() == 8554 && player.hasPlantedAB == false && player.mustRakeAB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 47) {
						player.getPackets().sendGameMessage("You need a Farming level of 47 to plant Melons.");
						return;
					}
					ArdyFarming.plantMelonAB(player, 712);
						player.allotmentB = 2;
						player.hasPlantedAB = true;
				//Onion, Level needed to grow = 5.
				} else if (itemId == 5319 && object.getId() == 8555 && player.hasPlantedAA == false && player.mustRakeAA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 47) {
						player.getPackets().sendGameMessage("You need a Farming level of 5 to plant Onion.");
						return;
					}
					ArdyFarming.plantOnionAA(player, 713);	
					player.allotmentA = 4;
					player.hasPlantedAA = true;
					
				} else if (itemId == 5319 && object.getId() == 8554 && player.hasPlantedAB == false && player.mustRakeAB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 5) {
						player.getPackets().sendGameMessage("You need a Farming level of 5 to plant Onion.");
						return;
					}
					ArdyFarming.plantOnionAB(player, 712);	
					player.allotmentB = 4;
					player.hasPlantedAB = true;
					//End of Onion.

					//Cabbage, Level needed to grow = 7.
				} else if (itemId == 5324 && object.getId() == 8555 && player.hasPlantedAA == false && player.mustRakeAA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 7) {
						player.getPackets().sendGameMessage("You need a Farming level of 7 to plant Cabbage.");
						return;
					}
					ArdyFarming.plantCabbageAA(player, 713);	
					player.allotmentA = 5;
					player.hasPlantedAA = true;
					
				} else if (itemId == 5324 && object.getId() == 8554 && player.hasPlantedAB == false && player.mustRakeAB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 7) {
						player.getPackets().sendGameMessage("You need a Farming level of 7 to plant Cabbage.");
						return;
					}
					ArdyFarming.plantCabbageAB(player, 712);	
					player.allotmentB = 5;
					player.hasPlantedAB = true;
					//End of Cabbage.

					//Tomato, Level needed to grow = 12.
				} else if (itemId == 5322 && object.getId() == 8555 && player.hasPlantedAA == false && player.mustRakeAA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 12) {
						player.getPackets().sendGameMessage("You need a Farming level of 12 to plant Tomato.");
						return;
					}
					ArdyFarming.plantTomatoAA(player, 713);	
					player.allotmentA = 6;
					player.hasPlantedAA = true;
					
				} else if (itemId == 5322 && object.getId() == 8554 && player.hasPlantedAB == false && player.mustRakeAB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 12) {
						player.getPackets().sendGameMessage("You need a Farming level of 12 to plant Tomato.");
						return;
					}
					ArdyFarming.plantTomatoAB(player, 712);	
					player.allotmentB = 6;
					player.hasPlantedAB = true;
					//End of Tomato.

					//Strawberry, Level needed to grow = 31.
				} else if (itemId == 5323 && object.getId() == 8555 && player.hasPlantedAA == false && player.mustRakeAA == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 31) {
						player.getPackets().sendGameMessage("You need a Farming level of 31 to plant this.");
						return;
					}
					ArdyFarming.plantStrawberryAA(player, 713);	
					player.allotmentA = 7;
					player.hasPlantedAA = true;
					
				} else if (itemId == 5323 && object.getId() == 8554 && player.hasPlantedAB == false && player.mustRakeAB == true) {
					if (player.getSkills().getLevel(Skills.FARMING) < 31) {
						player.getPackets().sendGameMessage("You need a Farming level of 31 to plant this.");
						return;
					}
					ArdyFarming.plantStrawberryAA(player, 712);	
					player.allotmentB = 7;
					player.hasPlantedAB = true;
					//End of Strawberry.
				} else if (itemId == 5321 && object.getId() == 8554 && player.hasPlantedAB == false && player.mustRakeAB == true) {
