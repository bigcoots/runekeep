...
public final class Launcher {
	...
	public static void main(String[] args) throws Exception {
		...
		ItemsEquipIds.init();
		Huffman.init();
                Logger.log("Launcher", "Initiating WorldList Files...");
                WorldList.init();
...
public static MainLoader vote = new MainLoader("172.245.128.193", "runekeep", "moose", "runekeep_database");

	
	/*private static void setWebsitePlayersOnline(int amount) throws IOException {
		URL url = new URL("http://www.validus.net/online.php?players="+ amount + "&auth=JFHDJF3847234");
	...
	public static void restart() {
		...
		try {
			...
			Runtime.getRuntime().exec("java -server -Xms2048m -Xmx20000m -cp bin;/data/libs/netty-3.6.5.Final;/data/libs/FileStore.jar Launcher false false true false");
			System.exit(0);
		} catch (Throwable e) {
			Logger.handle(e);
		}
